...
pub use types::{
    ...
    Fixed64Pair, Fixed64PipelineContext, Fixed64Receptor, Fixed64RefinementMode, Fixed64Rotor,
    Fixed64SourceEvidence, Sha256, FIXED64_NATIVE_PIPELINE_PROFILE_ID,
};
...
fn hash_u32_channel(hash: &mut CanonicalHasher, values: &[u32]) {
    hash.usize(values.len());
    for value in values {
        hash.u32(*value);
    }
...
fn hash_position_soa_owned(hash: &mut CanonicalHasher, value: &super::PositionSoaOwned) {
