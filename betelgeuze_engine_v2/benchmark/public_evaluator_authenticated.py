...
class AuthenticatedPublicBenchmarkCaseInput:
    ...
    def __post_init__(self) -> None:
        ...
        input_sha256 = _sha256(projection)
        prepared = PublicBenchmarkEvaluationCaseInput(
            ...
            authenticated_input_sha256=input_sha256,
        )
        ...
        object.__setattr__(self, "_input_sha256", input_sha256)
...
def run_authenticated_offline_public_benchmark_evaluation(
    ...
    *,
    ...
    try:
        boundary_source_sha256 = hashlib.sha256(
            Path(__file__).read_bytes()
        ).hexdigest()
    except OSError as exc:
        raise PublicBenchmarkEvaluatorDefect(
            "authentication-boundary source identity could not be authenticated"
        ) from exc
    return _run_prepared_evaluation(
        ...
        command=command,
        seed=seed,
        authentication_boundary_source_sha256=boundary_source_sha256,
    )
