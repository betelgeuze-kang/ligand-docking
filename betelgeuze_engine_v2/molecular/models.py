...
class StructureProvenance:
    ...
    def __post_init__(self) -> None:
        ...
        object.__setattr__(self, "source_sha256", str(self.source_sha256 or "").lower())
        ...
        object.__setattr__(self, "parent_sha256", tuple(str(value).lower() for value in self.parent_sha256))
        object.__setattr__(self, "metadata", dict(self.metadata))
