...
MMCIF_ALTLOC_SOURCE_CAPABILITY_ID = (
    "v2_bounded_mmcif_altloc_source_preservation"
)
...
CAPABILITY_BLOCKERS: dict[str, tuple[str, ...]] = {
    ...
    MMCIF_ALTLOC_SOURCE_CAPABILITY_ID: (
        "alternate_location_selection_not_performed",
...
def capability_snapshot() -> dict[str, Any]:
    ...
    payload = {
        ...
        "capabilities": {
            ...
            MMCIF_ALTLOC_SOURCE_CAPABILITY_ID: _row(
                MMCIF_ALTLOC_SOURCE_CAPABILITY_ID,
                current_state="bounded_atom_site_altloc_source_preservation",
                internal_execution_enabled=True,
                blocker_source="betelgeuze_engine_v2.capabilities.CAPABILITY_BLOCKERS",
            ),
