...
OPENMM_REFERENCE_RESULT_REVIEW_CONTRACT_SCHEMA_ID = (
    "betelgeuze.engine_v2_openmm_reference_result_review_contract/7.0.0"
)
OPENMM_REFERENCE_RESULT_REVIEW_ATTESTATION_SCHEMA_ID = (
    "betelgeuze.engine_v2_openmm_reference_result_review_attestation/7.0.0"
)
OPENMM_REFERENCE_RESULT_REVIEW_CONTRACT_ID = (
    "engine_v2_openmm_reference_independent_result_review/7.0.0"
)
OPENMM_REFERENCE_RESULT_REVIEW_CONTRACT_VERSION = "7.0.0"
OPENMM_REFERENCE_RESULT_REVIEW_CONTRACT_FROZEN_AT_UTC = "2026-07-24T18:55:00Z"
...
def _contract_projection() -> dict[str, Any]:
    return {
        ...
        "refreeze_reason": (
            "bind_energy_force_result_review_4_0_0_and_openmm_mapping_1_3_0_"
            "without_promoting_claim_gates"
        ),
