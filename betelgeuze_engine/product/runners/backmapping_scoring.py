"""Product runner adapter for ligand backmapping scoring.

The allowlisted CLI path remains ``tools/run_ligand_backmapping_scoring.py``.
...
_module = import_module("tools.product.run_ligand_backmapping_scoring")
