...
extern "C" BG_API bg_status BG_CALL bg_distance_constraints_v1_init(
    ...
    return guarded_status([&]() -> bg_status {
        if (constraints == nullptr) {
            return fail(BG_STATUS_INVALID_ARGUMENT, "constraints pointer is null");
        }
...
extern "C" BG_API bg_status BG_CALL bg_simulation_options_v1_init(
    ...
    return guarded_status([&]() -> bg_status {
        if (options == nullptr) {
            return fail(BG_STATUS_INVALID_ARGUMENT, "simulation options pointer is null");
        }
...
extern "C" BG_API bg_status BG_CALL bg_minimizer_options_v1_init(
    ...
    return guarded_status([&]() -> bg_status {
        if (options == nullptr) {
            return fail(BG_STATUS_INVALID_ARGUMENT, "minimizer options pointer is null");
        }
...
extern "C" BG_API bg_status BG_CALL bg_minimization_report_v1_init(
    ...
    return guarded_status([&]() -> bg_status {
        if (report == nullptr) {
            return fail(BG_STATUS_INVALID_ARGUMENT, "minimization report pointer is null");
        }
...
extern "C" BG_API bg_status BG_CALL bg_dynamics_report_v1_init(
    ...
    return guarded_status([&]() -> bg_status {
        if (report == nullptr) {
            return fail(BG_STATUS_INVALID_ARGUMENT, "dynamics report pointer is null");
        }
