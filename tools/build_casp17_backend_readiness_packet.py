        ...
        rows.append(
            {
                ...
                "command": "python3 tools/build_casp17_prediction_launch_packet.py",
            }
        )
    else:
        rows.append(
            {
                ...
                "command": "python3 tools/build_casp17_backend_profile_packet.py --supports-multimer",
            }
        )
    if accelerator_status == "rocm_gpu_ready":
        rows.append(
        ...
        rows.append(
            {
                ...
                "command": "Install a local isolated ColabFold env, verify colabfold_batch, then run build_casp17_prediction_launch_packet.py.",
            }
        )
    else:
        rows.append(
