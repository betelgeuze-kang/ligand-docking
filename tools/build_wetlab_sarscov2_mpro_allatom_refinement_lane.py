...
DEFAULT_BRANCH_SUMMARY_JSON = "runs/wetlab_sarscov2_mpro_exploratory_retry_lane_current.json"
DEFAULT_STAGE6_TUNING_SURFACE_JSON = "runs/wetlab_sarscov2_mpro_stage6_tuning_surface_current.json"
DEFAULT_OUT_MD = "runs/wetlab_sarscov2_mpro_allatom_refinement_lane_current.md"
DEFAULT_TOP_N = 32
...
def build_payload(
    ...
    *,
    ...
    payload["structured"]["branch_summary_artifact"] = "runs/wetlab_sarscov2_mpro_exploratory_retry_lane_current.md"
    payload["structured"]["stage6_tuning_surface_artifact"] = "runs/wetlab_sarscov2_mpro_stage6_tuning_surface_current.md"
    return payload


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the SARS-CoV-2 Mpro pseudo all-atom top-32 refinement lane.")
...
def main() -> None:
    ...
    write_artifact(args.out_md, "Wet-Lab SARS-CoV-2 Mpro All-Atom Refinement Lane", payload)
