"""Compatibility shim; canonical module: tools.accounting.build_family_manual_review_burndown."""
import sys as _sys
...
_module = _import_module("tools.accounting.build_family_manual_review_burndown")
