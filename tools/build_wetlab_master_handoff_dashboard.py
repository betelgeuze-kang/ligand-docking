"""Compatibility shim; canonical module: tools.accounting.build_wetlab_master_handoff_dashboard."""
# ruff: noqa: E402
import sys as _sys
...
_module = _import_module("tools.accounting.build_wetlab_master_handoff_dashboard")
...
def _sync_workspace():
    ...
    resolver = globals().get(
        ...
        getattr(_module, "resolve_selected_allatom_canonical", None),
    )
    if resolver is not None:
        _module.resolve_selected_allatom_canonical = resolver
...
if __name__ == "__main__":
    ...
    if _entry is None:
        raise SystemExit("builder has no main(): tools.accounting.build_wetlab_master_handoff_dashboard")
