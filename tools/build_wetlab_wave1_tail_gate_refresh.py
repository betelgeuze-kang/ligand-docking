...
STEP_SPECS: list[tuple[str, list[str], str]] = [
    ("stk17b_run_record", ["tools/build_stk17b_run_record.py"], "runs/stk17b_run_record_current.json"),
    ("stk17b_run_status", ["tools/build_stk17b_run_status.py"], "runs/stk17b_run_status_current.json"),
    ("lbdhodh_result_review", ["tools/build_lbdhodh_result_review.py"], "runs/lbdhodh_result_review_current.json"),
    ("lbdhodh_run_record", ["tools/build_lbdhodh_run_record.py"], "runs/lbdhodh_run_record_current.json"),
    ("wave1_tail_run_queue", ["tools/build_wetlab_wave1_tail_protein_run_queue.py"], "runs/wetlab_wave1_tail_protein_run_queue_current.json"),
    ("wave1_tail_chain_stack", ["tools/build_wetlab_wave1_tail_chain_stack.py"], "runs/wetlab_wave1_tail_chain_stack_current.json"),
]
