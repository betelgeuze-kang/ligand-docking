"""Compatibility shim; canonical module: tools.accounting.build_wetlab_monitor_semantics."""
# ruff: noqa: E402
import sys as _sys
...
_module = _import_module("tools.accounting.build_wetlab_monitor_semantics")
...
if __name__ == "__main__":
    ...
    if _entry is None:
        raise SystemExit("builder has no main(): tools.accounting.build_wetlab_monitor_semantics")
