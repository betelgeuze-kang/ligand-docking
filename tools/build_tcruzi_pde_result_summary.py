...
DEFAULT_OUT_MD = "runs/tcruzi_pde_result_summary_current.md"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Write the canonical T. cruzi PDE result-summary artifact.")
...
def build_payload(
    ...
    return build_result_summary_payload(
        ...
        launch_artifact="runs/tcruzi_pde_launch_packet_current.md",
...
def main() -> None:
    ...
    write_artifact(DEFAULT_OUT_MD, "T. cruzi PDE Result Summary", payload)
