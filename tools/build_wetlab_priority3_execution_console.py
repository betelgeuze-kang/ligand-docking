...
DEFAULT_RUNTIME_EVENT_JSON = "runs/wetlab_priority3_runtime_event_current.json"
DEFAULT_RUNTIME_RUNBOOK_JSON = "runs/wetlab_priority3_runtime_runbook_current.json"
DEFAULT_EVENT_LOG = "runs/wetlab_priority3_runtime_event_log.jsonl"
...
def build_payload(
    ...
    return {
        "summary": {
            "status": "wetlab_priority3_execution_console_ready",
        ...
        "structured": {
            ...
            "runtime_runbook_artifact": "runs/wetlab_priority3_runtime_runbook_current.md",
...
def main() -> None:
    ...
    write_artifact(DEFAULT_OUT_MD, "Wet-Lab Priority3 Execution Console", payload)
