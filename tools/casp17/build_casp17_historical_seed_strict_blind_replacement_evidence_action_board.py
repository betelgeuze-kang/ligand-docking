            ...
            rows.append(
                {
                    ...
                    "verify_command": (
                        "python3 tools/casp17/build_casp17_historical_seed_strict_blind_replacement_evidence_quality_audit.py"
                    ),
...
def _blocked_patch_action(
    ...
    return {
        ...
        "verify_command": "python3 tools/casp17/build_casp17_historical_seed_strict_blind_replacement_evidence_dropzones.py",
