    ...
    rows = [
        ...
        _row(
            ...
            command=(
                ...
                "python3 tools/casp17/build_casp17_historical_input_workorder_packet.py"
            ),
        ...
        _row(
            ...
            command="python3 tools/casp17/build_casp17_refinement_ablation_packet.py --manifest-csv runs/casp17_historical_benchmark_manifest_current.csv",
        ...
        _row(
            ...
            command="python3 tools/casp17/build_casp17_model_selection_calibration_scaffold.py",
        ...
        _row(
            ...
            command=(
                "python3 tools/casp17/build_casp17_structure_render_packet.py "
                "--prediction-dir runs/casp17_predictions_statistical_rotamer_current "
        ...
        _row(
            ...
            command="python3 tools/casp17/build_casp17_submission_gate_packet.py --intake-csv runs/casp17_target_intake_scored_statistical_rotamer_current.csv",
