...
def _manual_attach_row() -> dict[str, Any]:
    return {
        ...
        "validation_command": "python3 tools/casp17/build_casp17_existing_structure_file_checklist.py --write-provenance-scaffold",
...
def _detected_backend_row(selected_backend: str) -> dict[str, Any]:
    return {
        ...
        "cpu_fallback_allowed": False,
        "installation_executed": False,
        "command_template": "python3 tools/casp17/build_casp17_prediction_launch_packet.py",
        "validation_command": "python3 tools/casp17/run_casp17_target_attempt_gate.py --target-id <TARGET_ID>",
...
def _custom_backend_row() -> dict[str, Any]:
    return {
        ...
        "installation_executed": False,
        "command_template": (
            "python3 tools/casp17/build_casp17_backend_profile_packet.py --supports-multimer && "
            "python3 tools/casp17/build_casp17_prediction_coverage_gate.py"
        ),
        "validation_command": "python3 tools/casp17/run_casp17_target_attempt_gate.py --target-id <TARGET_ID> --execute --author-code <CASP_AUTHOR_CODE>",
...
def _cuda_env_row(env_path: str) -> dict[str, Any]:
    return {
        ...
        "validation_command": "colabfold_batch --help && python3 tools/casp17/build_casp17_prediction_launch_packet.py",
...
def _gpu_enablement_row() -> dict[str, Any]:
    return {
        ...
        "validation_command": "python3 tools/casp17/build_casp17_backend_readiness_packet.py",
