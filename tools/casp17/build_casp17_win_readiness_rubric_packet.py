...
def build_payload(args: argparse.Namespace) -> dict[str, Any]:
    ...
    rows = [
        ...
        _row(
            ...
            next_action="Populate historical ablation layer directories or layer-specific manifest prediction columns, then run casp17/build_casp17_refinement_ablation_packet.py.",
