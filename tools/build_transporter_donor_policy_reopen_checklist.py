...
def build_payload(
    ...
    rows = [
        {
            ...
            "status": "blocked",
            "current_value": f"aqp1_binder_defer={aqp1_binder_defer}; glut1_binder_defer={glut1_binder_defer}",
        ...
        },
        {
            ...
            "status": "blocked",
            "current_value": f"aqp1_keep_review_only={aqp1_review_only}; glut1_keep_review_only={glut1_review_only}",
    ...
    summary = {
        ...
        "next_required_step": (
            "Keep the transporter donor policy frozen for scaffold-only use. Re-open only after at least one transporter binder row is no longer placeholder-driven "
            "and the transporter P0 scaffold blockers are cleared."
        ),
    }
