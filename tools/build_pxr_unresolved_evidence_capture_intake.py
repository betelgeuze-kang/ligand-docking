...
def main() -> None:
    ...
    if payload["summary"]["intake_applied"]:
        ...
        _run("build_pxr_pending_policy_note.py")
        _run("build_pxr_next_verification_slice.py", "--capture-sheet-json", str(_resolve("runs/pxr_unresolved_evidence_capture_sheet_current.json")))
        _run("build_pxr_pending_resolution_packet.py")
        _run("build_pxr_evidence_closure_day_plan.py")
        _run("build_pxr_reviewer_workbench.py")
        _run("build_pxr_pending_resolution_reviewer_draft_packet.py")
        _run("build_pxr_review_packet.py")
        _run(
            "build_pxr_pending_resolution_commit_packet.py",
            "--existing-sheet-csv",
            capture_sheet_path,
            "--out-json",
        ...
        _run("build_pxr_pending_burndown_console.py")
        ...
        _run("build_pxr_literature_candidate_overlay.py")
        _run("build_family_evidence_investigator_packet.py")
        _run("build_pxr_exact_source_confirmation_packet.py")
        _run("build_pxr_conflict_resolver_packet.py")
        ...
        _run("build_cross_family_residual_shadow_layer.py")
