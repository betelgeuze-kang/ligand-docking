"""Compatibility shim; canonical module: tools.accounting.build_wetlab_broad_screen_primary_watch_state."""
# ruff: noqa: E402
import sys as _sys
...
_module = _import_module("tools.accounting.build_wetlab_broad_screen_primary_watch_state")
...
def _sync_workspace():
    ...
    detector = globals().get(
        ...
        getattr(_module, "detect_hard_target_rescue_lane", None),
    )
    if detector is not None:
        _module.detect_hard_target_rescue_lane = detector
...
if __name__ == "__main__":
    ...
    if _entry is None:
        raise SystemExit("builder has no main(): tools.accounting.build_wetlab_broad_screen_primary_watch_state")
