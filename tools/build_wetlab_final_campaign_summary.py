"""Compatibility shim; canonical module: tools.accounting.build_wetlab_final_campaign_summary."""
import sys as _sys
...
if __name__ == "__main__":
    ...
    if _entry is None:
        raise SystemExit("builder has no main(): tools.accounting.build_wetlab_final_campaign_summary")
