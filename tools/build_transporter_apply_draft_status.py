...
def _write_markdown(path: Path, payload: dict[str, Any]) -> None:
    ...
    lines = [
        ...
        "",
        "| target_id | draft_apply_status | binder_slot_count | binder_seed_row_count | pending_manual_verdict_count | suggested_prefill_count | note_template_count | packet_queue_count | packet_workbook_row_count | ready_for_apply_rows | staged_non_authoritative_rows | placeholder_driven_rows | second_wave_source_confirmation_ready | second_wave_source_confirmation_row_count | second_wave_source_confirmation_primary_focus_ligand | direct_quantitative_binding_count | exact_target_pair_activity_count | structured_pair_absent_count | exact_human_activity_count | quantitative_provenance_signal | next_required_step |",
        "| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | --- | ---: | ---: | ---: | ---: | --- | --- |",
    ]
