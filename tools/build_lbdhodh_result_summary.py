...
DEFAULT_GO_NO_GO_JSON = "runs/lbdhodh_go_no_go_card_current.json"
DEFAULT_OUT_MD = "runs/lbdhodh_result_summary_current.md"
TARGET_ID = "Leishmania braziliensis DHODH"
TRACK_ID = "DNDi_IPK"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Write the canonical LbDHODH result-summary artifact.")
...
def build_payload(launch_payload: dict, go_no_go_payload: dict, status: str = "not_ready", decision_case: str = "", action: str = "", started_at: str = "", updated_at: str = "", completed_at: str = "", notes: str = "") -> dict:
    ...
    return build_result_summary_payload(
        ...
        go_no_go_artifact="runs/lbdhodh_go_no_go_card_current.md",
...
def main() -> None:
    ...
    write_artifact(DEFAULT_OUT_MD, "LbDHODH Result Summary", payload)
