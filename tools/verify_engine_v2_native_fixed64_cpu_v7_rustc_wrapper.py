#!/usr/bin/python3.10
"""Fail closed unless v7 qualification crates receive the frozen rustc flags."""
...
QUALIFICATION_BUILD_ENV = "BETELGEUZE_V7_QUALIFICATION_BUILD"
VERIFIED_CFG = "betelgeuze_v7_effective_rust_flags_verified"
...
CONTROLLED_BINARY_CRATE = "betelgeuze_fixed64_cpu_qualify_v7"
...
def _fail(message: str) -> NoReturn:
    print(
        f"native fixed64 CPU v7 rustc wrapper rejected build: {message}",
        file=sys.stderr,
    )
    raise SystemExit(86)
