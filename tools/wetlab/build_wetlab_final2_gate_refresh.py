...
STEP_COMMANDS = [
    ("stk17b_run_record", "tools/wetlab/build_stk17b_run_record.py"),
    ("stk17b_run_status", "tools/wetlab/build_stk17b_run_status.py"),
    ...
    ("lbdhodh_run_record", "tools/wetlab/build_lbdhodh_run_record.py"),
