    ...
    rows = [
        {
            ...
            "command": "python3 tools/run_wetlab_wave1_tail_runtime_event.py --target stk17b --event start --active-stage-label open_set_dark_kinase_primary_assay --started-at <started_at_iso> --updated-at <started_at_iso>",
        ...
        },
        {
            ...
            "command": "python3 tools/run_wetlab_wave1_tail_runtime_event.py --target stk17b --event complete --active-stage-label open_set_dark_kinase_primary_assay --decision-case stk17b_open_set_pass --action promote --started-at <started_at_iso> --updated-at <completed_at_iso> --completed-at <completed_at_iso>",
        ...
        },
        {
            ...
            "command": "python3 tools/run_wetlab_wave1_tail_runtime_event.py --target stk17b --event hold --active-stage-label open_set_dark_kinase_primary_assay --decision-case explicit_hold --action hold --started-at <started_at_iso> --updated-at <completed_at_iso> --completed-at <completed_at_iso>",
            "expected_gate_artifact": "runs/lbdhodh_result_review_current.md",
        ...
        },
        {
            ...
            "command": "python3 tools/run_wetlab_wave1_tail_runtime_event.py --target lbdhodh --event start --active-stage-label parasite_dhodh_primary_assay --started-at <started_at_iso> --updated-at <started_at_iso>",
            "expected_gate_artifact": "runs/lbdhodh_result_review_current.md",
        ...
        },
        {
            ...
            "command": "python3 tools/run_wetlab_wave1_tail_runtime_event.py --target lbdhodh --event hold --active-stage-label parasite_dhodh_primary_assay --decision-case explicit_hold --action hold --started-at <started_at_iso> --updated-at <completed_at_iso> --completed-at <completed_at_iso>",
            "expected_gate_artifact": "runs/lbdhodh_result_review_current.md",
        ...
        },
        {
            ...
            "command": "python3 tools/run_wetlab_wave1_tail_runtime_event.py --target <stk17b|lbdhodh> --event reset",
