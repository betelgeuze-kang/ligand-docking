...
POST_ACTION_SCRIPTS = [
    ...
    "tools/wetlab/build_wetlab_sarscov2_mpro_stage6_tuning_surface.py",
    "tools/wetlab/wetlab/build_wetlab_sarscov2_mpro_exploratory_retry_lane.py",
    "tools/wetlab/build_wetlab_tcruzi_pde_stage6_tuning_surface.py",
    "tools/wetlab/wetlab/build_wetlab_tcruzi_pde_exploratory_retry_lane.py",
    "tools/wetlab/wetlab/build_wetlab_target_retry_policy_templates.py",
    "tools/wetlab/wetlab/build_wetlab_mapping_fix_retry_policy_templates.py",
    "tools/wetlab/wetlab/build_wetlab_stk17b_manual_retry_lane.py",
    "tools/build_wetlab_stk17b_exploratory_retry_lane.py",
    "tools/wetlab/wetlab/build_wetlab_stk17b_exploratory_trace.py",
    "tools/wetlab/wetlab/build_wetlab_stk17b_exploratory_followup_lane.py",
    "tools/wetlab/wetlab/build_wetlab_stk17b_followup_review_surface.py",
    "tools/wetlab/wetlab/build_wetlab_retry_handoff_summary.py",
