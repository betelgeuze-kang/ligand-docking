...
DEFAULT_STEPS: list[tuple[str, list[str], str]] = [
    ...
    ("dengue_ns2b_ns3_protease_launch_packet", ["tools/wetlab/wetlab/build_dengue_ns2b_ns3_protease_launch_packet.py"], "runs/dengue_ns2b_ns3_protease_launch_packet_current.json"),
    ...
    ("dengue_ns2b_ns3_protease_run_record", ["tools/wetlab/wetlab/build_dengue_ns2b_ns3_protease_run_record.py"], "runs/dengue_ns2b_ns3_protease_run_record_current.json"),
    ...
    ("tcruzi_krs1_render_suite", ["tools/wetlab/wetlab/build_tcruzi_krs1_render_suite.py"], "runs/tcruzi_krs1_render_suite_current.json"),
    ("tcruzi_krs1_launch_packet", ["tools/wetlab/wetlab/build_tcruzi_krs1_launch_packet.py"], "runs/tcruzi_krs1_launch_packet_current.json"),
    ("tcruzi_krs1_result_review", ["tools/build_tcruzi_krs1_result_review.py"], "runs/tcruzi_krs1_result_review_current.json"),
    ("tcruzi_krs1_run_record", ["tools/wetlab/wetlab/build_tcruzi_krs1_run_record.py"], "runs/tcruzi_krs1_run_record_current.json"),
