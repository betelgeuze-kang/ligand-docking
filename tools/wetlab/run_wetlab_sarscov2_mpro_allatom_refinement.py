...
DEFAULT_OUT_MD = "runs/wetlab_sarscov2_mpro_allatom_refinement_runner_current.md"
DEFAULT_TOP_K = 8


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the SARS-CoV-2 Mpro pseudo all-atom refinement slice.")
