...
def main() -> None:
    ...
    if payload["summary"]["intake_applied"]:
        _run("build_transporter_manual_review_quickstart_packet.py")
        _run("build_transporter_apply_draft_status.py")
        _run("build_transporter_manual_review_dashboard.py")
        _run("build_transporter_seed_row_promotion_board.py")
        _run("build_transporter_manual_review_launchboard.py")
