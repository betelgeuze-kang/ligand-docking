"""Compatibility shim; canonical module: tools.accounting.build_local_engine_commercialization_queue."""
# ruff: noqa: E402
import sys as _sys
...
_module = _import_module("tools.accounting.build_local_engine_commercialization_queue")
...
def _discover_nightly_scan_paths(*args, **kwargs):
    _sync_workspace()
    return _module._discover_nightly_scan_paths(*args, **kwargs)
...
if __name__ == "__main__":
    ...
    if _entry is None:
        raise SystemExit("builder has no main(): tools.accounting.build_local_engine_commercialization_queue")
