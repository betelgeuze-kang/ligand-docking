...
DEFAULT_OUT_MD = "runs/caix_live_progress_current.md"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Write the canonical CA IX live-progress artifact.")
...
def main() -> None:
    ...
    write_artifact(DEFAULT_OUT_MD, "CA IX Live Progress", payload)
