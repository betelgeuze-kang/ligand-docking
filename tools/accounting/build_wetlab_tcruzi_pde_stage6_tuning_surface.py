...
DEFAULT_OUT_MD = "runs/wetlab_tcruzi_pde_stage6_tuning_surface_current.md"
...
def build_payload(execution_queue_payload: dict, throughput_bridge_payload: dict) -> dict:
    payload = build_stage6_tuning_payload(
        ...
        next_step_template=(
            "Keep the {target_id} default lane closed and reopen it only through the gate5.1 tuned retry family; "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the T. cruzi PDE stage6 tuning surface.")
...
def main() -> None:
    ...
    write_artifact(
        args.out_md,
        "Wet-Lab T. cruzi PDE Stage6 Tuning Surface",
