...
TARGETS: dict[str, dict[str, str]] = {
    ...
    "alk2": {
        "target_id": "ALK2",
        "progress_builder": "tools/build_alk2_live_progress.py",
        "result_builder": "tools/build_alk2_result_summary.py",
        "run_record_json": "runs/alk2_run_record_current.json",
        "gate_json": "runs/alk2_result_review_current.json",
    },
}
...
def build_payload(event_result: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "summary": {
            "status": "wetlab_next3_runtime_event_applied",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Apply a runtime event to a next3 serialized wet-lab target and refresh downstream gates.")
...
def main() -> None:
    ...
    write_artifact(DEFAULT_OUT_MD, "Wet-Lab Next3 Runtime Event", payload)
