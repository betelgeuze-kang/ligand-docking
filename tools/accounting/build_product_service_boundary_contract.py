...
DEFAULT_OUT_JSON = "runs/product_service_boundary_contract_current.json"
DEFAULT_OUT_CSV = "runs/product_service_boundary_contract_current.csv"
DEFAULT_OUT_MD = "runs/product_service_boundary_contract_current.md"
...
def _write_markdown(path_like: str | Path, payload: dict) -> None:
    ...
    s = payload["summary"]
    lines = [
        "# Product Service Boundary Contract",
        "",
        f"- status: `{s['status']}`",
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the product service-boundary contract from local source files.")
...
def main(argv: list[str] | None = None) -> None:
    ...
    payload = build_product_service_boundary_contract(root=args.root)
