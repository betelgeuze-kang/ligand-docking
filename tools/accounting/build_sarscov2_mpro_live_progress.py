...
DEFAULT_OUT_MD = "runs/sarscov2_mpro_live_progress_current.md"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Write the canonical SARS-CoV-2 Mpro live-progress artifact.")
...
def main() -> None:
    ...
    write_artifact(DEFAULT_OUT_MD, "SARS-CoV-2 Mpro Live Progress", payload)
