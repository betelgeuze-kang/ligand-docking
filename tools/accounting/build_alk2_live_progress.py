...
DEFAULT_OUT_MD = "runs/alk2_live_progress_current.md"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Write the canonical ALK2 live-progress artifact.")
...
def main() -> None:
    ...
    write_artifact(DEFAULT_OUT_MD, "ALK2 Live Progress", payload)
