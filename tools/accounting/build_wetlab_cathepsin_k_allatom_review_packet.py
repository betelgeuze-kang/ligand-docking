...
DEFAULT_RUNNER_JSON = "runs/wetlab_cathepsin_k_allatom_refinement_runner_current.json"
DEFAULT_OUT_MD = "runs/wetlab_cathepsin_k_allatom_review_packet_current.md"
...
def build_payload(
    ...
    *,
    ...
    payload["structured"]["allatom_refinement_lane_artifact"] = "runs/wetlab_cathepsin_k_allatom_refinement_lane_current.md"
    payload["structured"]["allatom_runner_artifact"] = "runs/wetlab_cathepsin_k_allatom_refinement_runner_current.md"
    return payload


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the Cathepsin K pseudo all-atom review packet.")
...
def main() -> None:
    ...
    write_artifact(args.out_md, "Wet-Lab Cathepsin K All-Atom Review Packet", payload)
