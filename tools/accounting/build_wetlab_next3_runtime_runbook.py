    ...
    rows = [
        {
            ...
            "command": "python3 tools/build_wetlab_next3_runtime_event.py --target cruzain --event start --active-stage-label parasite_cysteine_protease_primary_assay --started-at <started_at_iso> --updated-at <started_at_iso>",
        ...
        },
        {
            ...
            "command": "python3 tools/build_wetlab_next3_runtime_event.py --target cruzain --event complete --active-stage-label parasite_cysteine_protease_primary_assay --decision-case promote_clean_cruzain_favored --action promote --started-at <started_at_iso> --updated-at <completed_at_iso> --completed-at <completed_at_iso>",
        ...
        },
        {
            ...
            "command": "python3 tools/build_wetlab_next3_runtime_event.py --target cruzain --event hold --active-stage-label parasite_cysteine_protease_primary_assay --decision-case explicit_hold --action hold --started-at <started_at_iso> --updated-at <completed_at_iso> --completed-at <completed_at_iso>",
            "expected_gate_artifact": "runs/sarscov2_plpro_result_review_current.md",
        ...
        },
        {
            ...
            "command": "python3 tools/build_wetlab_next3_runtime_event.py --target sarscov2_plpro --event start --active-stage-label antiviral_dub_primary_assay --started-at <started_at_iso> --updated-at <started_at_iso>",
            "expected_gate_artifact": "runs/sarscov2_plpro_result_review_current.md",
        ...
        },
        {
            ...
            "command": "python3 tools/build_wetlab_next3_runtime_event.py --target sarscov2_plpro --event complete --active-stage-label antiviral_dub_primary_assay --decision-case promote_clean_plpro_favored --action promote --started-at <started_at_iso> --updated-at <completed_at_iso> --completed-at <completed_at_iso>",
        ...
        },
        {
            ...
            "command": "python3 tools/build_wetlab_next3_runtime_event.py --target sarscov2_plpro --event hold --active-stage-label antiviral_dub_primary_assay --decision-case explicit_hold --action hold --started-at <started_at_iso> --updated-at <completed_at_iso> --completed-at <completed_at_iso>",
            "expected_gate_artifact": "runs/alk2_result_review_current.md",
        ...
        },
        {
            ...
            "command": "python3 tools/build_wetlab_next3_runtime_event.py --target alk2 --event start --active-stage-label mutant_selective_primary_assay --started-at <started_at_iso> --updated-at <started_at_iso>",
            "expected_gate_artifact": "runs/alk2_result_review_current.md",
        ...
        },
        {
            ...
            "command": "python3 tools/build_wetlab_next3_runtime_event.py --target alk2 --event complete --active-stage-label mutant_selective_primary_assay --decision-case alk2_mutant_selective_pass --action advance_to_later_release_review --started-at <started_at_iso> --updated-at <completed_at_iso> --completed-at <completed_at_iso>",
            "expected_gate_artifact": "runs/alk2_result_review_current.md",
        ...
        },
        {
            ...
            "command": "python3 tools/build_wetlab_next3_runtime_event.py --target alk2 --event hold --active-stage-label mutant_selective_primary_assay --decision-case explicit_hold --action hold --started-at <started_at_iso> --updated-at <completed_at_iso> --completed-at <completed_at_iso>",
            "expected_gate_artifact": "runs/alk2_result_review_current.md",
        ...
        },
        {
            ...
            "command": "python3 tools/build_wetlab_next3_runtime_event.py --target <cruzain|sarscov2_plpro|alk2> --event reset",
