...
DEFAULT_OUT_MD = "runs/lbdhodh_live_progress_current.md"
TARGET_ID = "Leishmania braziliensis DHODH"
TRACK_ID = "DNDi_IPK"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Write the canonical LbDHODH live-progress artifact.")
...
def main() -> None:
    ...
    write_artifact(DEFAULT_OUT_MD, "LbDHODH Live Progress", payload)
