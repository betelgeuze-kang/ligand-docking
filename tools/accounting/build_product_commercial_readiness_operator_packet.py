...
DEFAULT_PRODUCT_SCOPE_BREADTH_EVIDENCE_STAGING_APPLY_JSON = (
...
def build_product_commercial_readiness_operator_packet(
    *,
    ...
    product_scope_breadth_evidence_staging_apply_path: str = (
        DEFAULT_PRODUCT_SCOPE_BREADTH_EVIDENCE_STAGING_APPLY_JSON
    ),
    ...
    product_scope_breadth_evidence_staging_apply = _summary(
        product_scope_breadth_evidence_staging_apply_packet or {}
    )
    ...
    out_summary = {
        ...
        "product_scope_breadth_evidence_operator_staging_apply_artifact": (
            product_scope_breadth_evidence_staging_apply_path
        ),
        "product_scope_breadth_evidence_operator_staging_apply_status": _text(
            product_scope_breadth_evidence_staging_apply.get("status")
        ),
        "product_scope_breadth_evidence_operator_staging_apply_candidate_receipt_ready": bool(
            product_scope_breadth_evidence_staging_apply.get("candidate_receipt_ready") is True
        ),
        "product_scope_breadth_evidence_operator_staging_apply_candidate_blocked_row_count": _int(
            product_scope_breadth_evidence_staging_apply.get("candidate_blocked_row_count")
        ),
        "product_scope_breadth_evidence_operator_staging_apply_candidate_pass_row_count": _int(
            product_scope_breadth_evidence_staging_apply.get("candidate_pass_row_count")
        ),
        "product_scope_breadth_evidence_operator_staging_apply_staging_placeholder_row_count": _int(
            product_scope_breadth_evidence_staging_apply.get("staging_placeholder_row_count")
        ),
        "product_scope_breadth_evidence_operator_staging_apply_field_worksheet_pending_field_count": _int(
            product_scope_breadth_evidence_staging_apply.get("field_worksheet_pending_field_count")
        ),
        "product_scope_breadth_evidence_operator_staging_apply_first_blocked_scope_blocker_id": _text(
            product_scope_breadth_evidence_staging_apply.get("candidate_first_blocked_scope_blocker_id")
        ),
        "product_scope_breadth_evidence_operator_staging_apply_most_common_row_blocker": _text(
            product_scope_breadth_evidence_staging_apply.get("candidate_most_common_row_blocker")
        ),
        "product_scope_breadth_evidence_operator_staging_apply_live_copy_allowed": bool(
            product_scope_breadth_evidence_staging_apply.get("live_copy_allowed") is True
        ),
        "product_scope_breadth_evidence_operator_staging_apply_canonical_receipt_written": bool(
            product_scope_breadth_evidence_staging_apply.get("canonical_receipt_written") is True
        ),
        "product_scope_breadth_evidence_operator_staging_apply_external_state_mutated": bool(
            product_scope_breadth_evidence_staging_apply.get("external_state_mutated") is True
        ),
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--product-scope-breadth-evidence-staging-apply-json",
        default=DEFAULT_PRODUCT_SCOPE_BREADTH_EVIDENCE_STAGING_APPLY_JSON,
    )
    parser.add_argument(
...
def main(argv: list[str] | None = None) -> None:
    ...
    payload = build_product_commercial_readiness_operator_packet(
        ...
        product_scope_breadth_evidence_staging_apply_packet=_read_json_if_present(
            args.product_scope_breadth_evidence_staging_apply_json
        ),
