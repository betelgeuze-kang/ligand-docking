...
def _write_markdown(path_like: str | Path, payload: dict[str, Any]) -> None:
    ...
    lines = [
        ...
        f"- public_benchmark_suite_result_provenance_command_count: `{s['public_benchmark_suite_result_provenance_command_count']}`",
        f"- public_benchmark_suite_result_provenance_present_count: `{s['public_benchmark_suite_result_provenance_present_count']}`",
        ...
        f"- public_benchmark_work_order_suite_result_provenance_command_count: `{s['public_benchmark_work_order_suite_result_provenance_command_count']}`",
        f"- public_benchmark_work_order_suite_result_provenance_present_count: `{s['public_benchmark_work_order_suite_result_provenance_present_count']}`",
