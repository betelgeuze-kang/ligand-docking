...
DEFAULT_OUT_MD = "runs/wetlab_cathepsin_k_stage6_tuning_surface_current.md"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the Cathepsin K stage6 tuning surface.")
...
def main() -> None:
    ...
    write_artifact(
        args.out_md,
        "Wet-Lab Cathepsin K Stage6 Tuning Surface",
