...
DEFAULT_OUT_MD = "runs/cathepsin_k_live_progress_current.md"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Write the canonical Cathepsin K live-progress artifact.")
...
def main() -> None:
    ...
    write_artifact(DEFAULT_OUT_MD, "Cathepsin K Live Progress", payload)
