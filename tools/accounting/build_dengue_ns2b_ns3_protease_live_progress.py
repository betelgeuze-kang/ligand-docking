...
DEFAULT_OUT_MD = "runs/dengue_ns2b_ns3_protease_live_progress_current.md"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Write the canonical Dengue NS2B-NS3 protease live-progress artifact.")
...
def main() -> None:
    ...
    write_artifact(DEFAULT_OUT_MD, "Dengue NS2B-NS3 Protease Live Progress", payload)
