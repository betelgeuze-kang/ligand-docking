...
DEFAULT_OUT_MD = "runs/cruzain_live_progress_current.md"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Write the canonical Cruzain live-progress artifact.")
...
def main() -> None:
    ...
    write_artifact(DEFAULT_OUT_MD, "Cruzain Live Progress", payload)
