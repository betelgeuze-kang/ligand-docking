...
from tools.build_wetlab_cathepsin_k_tuned_operator_packet import TEMPLATE
from tools.wetlab.wetlab_hard_target_branch_builder import build_branch_summary_payload
from tools.wetlab_target_render_utils import load_json, write_artifact

DEFAULT_OPERATOR_PACKET_JSON = "runs/wetlab_cathepsin_k_tuned_operator_packet_current.json"
...
DEFAULT_OUT_MD = "runs/wetlab_cathepsin_k_tuned_branch_summary_current.md"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the Cathepsin K tuned branch summary.")
...
def main() -> None:
    ...
    write_artifact(args.out_md, "Wet-Lab Cathepsin K Tuned Branch Summary", payload)
