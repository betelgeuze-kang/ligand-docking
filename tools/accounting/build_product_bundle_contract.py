...
DEFAULT_OUT_JSON = "runs/product_bundle_contract_current.json"
DEFAULT_OUT_CSV = "runs/product_bundle_contract_current.csv"
DEFAULT_OUT_MD = "runs/product_bundle_contract_current.md"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate a product local-delivery bundle command without assembling a bundle.")
...
def main(argv: list[str] | None = None) -> None:
    ...
    payload = build_product_bundle_contract(
        _read_json(args.work_order_json),
