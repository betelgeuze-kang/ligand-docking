    ...
    *,
    ...
    summary = {
        ...
        "full_commercial_release_allowed": bool(
            action_board_summary.get("full_commercial_release_allowed") is True
        ),
        "full_commercial_release_blocker_count": _int(
            action_board_summary.get("full_commercial_release_blocker_count")
        ),
        "full_commercial_release_blocker_ids": _text_list(
            action_board_summary.get("full_commercial_release_blocker_ids")
        ),
        "full_commercial_release_next_required_step": _text(
            action_board_summary.get("full_commercial_release_next_required_step")
        ),
        "science_claim_promotion_gap_closure_open_gap_ids": _text_list(
            action_board_summary.get("science_claim_promotion_gap_closure_open_gap_ids")
        ),
        ...
        "accuracy_parity_ligand_ranking_pr_auc": _float(
            action_board_summary.get("accuracy_parity_ligand_ranking_pr_auc")
        ),
        "accuracy_parity_ligand_ranking_pr_auc_ci_low": _float(
            action_board_summary.get("accuracy_parity_ligand_ranking_pr_auc_ci_low")
        ),
        "accuracy_parity_ligand_ranking_topk_hit_rate": _float(
            action_board_summary.get("accuracy_parity_ligand_ranking_topk_hit_rate")
        ),
        "accuracy_parity_ligand_ranking_next_required_step": _text(
            action_board_summary.get("accuracy_parity_ligand_ranking_next_required_step")
        ),
        "primary_full_commercial_release_blocker_id": _text(
            action_board_summary.get("primary_full_commercial_release_blocker_id")
        ),
        "primary_full_commercial_release_blocker_requirement_id": _text(
            action_board_summary.get("primary_full_commercial_release_blocker_requirement_id")
        ),
        "primary_full_commercial_release_blocker_tier": _text(
            action_board_summary.get("primary_full_commercial_release_blocker_tier")
        ),
        "primary_full_commercial_release_blocker_blocked_row_count": _int(
            action_board_summary.get("primary_full_commercial_release_blocker_blocked_row_count")
        ),
        "primary_full_commercial_release_blocker_first_blocked_evidence_row_id": _text(
            action_board_summary.get("primary_full_commercial_release_blocker_first_blocked_evidence_row_id")
        ),
        "primary_full_commercial_release_blocker_receipt_csv": _text(
            action_board_summary.get("primary_full_commercial_release_blocker_receipt_csv")
        ),
        "primary_full_commercial_release_blocker_approval_token_required": _text(
            action_board_summary.get("primary_full_commercial_release_blocker_approval_token_required")
        ),
        "primary_full_commercial_release_blocker_next_required_step": _text(
            action_board_summary.get("primary_full_commercial_release_blocker_next_required_step")
        ),
        "product_full_commercial_blocker_evidence_matrix_r8_blocked_row_count": _int(
            action_board_summary.get("product_full_commercial_blocker_evidence_matrix_r8_blocked_row_count")
        ),
        ...
        "product_full_commercial_blocker_evidence_matrix_r8_receipt_csv": _text(
            action_board_summary.get("product_full_commercial_blocker_evidence_matrix_r8_receipt_csv")
        ),
        ...
        "product_full_commercial_blocker_evidence_matrix_r9_blocked_row_count": _int(
            action_board_summary.get("product_full_commercial_blocker_evidence_matrix_r9_blocked_row_count")
        ),
        ...
        "product_full_commercial_blocker_evidence_matrix_r9_receipt_csv": _text(
            action_board_summary.get("product_full_commercial_blocker_evidence_matrix_r9_receipt_csv")
        ),
