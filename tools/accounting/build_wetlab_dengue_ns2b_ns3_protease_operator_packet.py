...
from tools.wetlab.wetlab_hard_target_branch_builder import HardTargetBranchTemplate, build_operator_packet_payload
from tools.wetlab_target_render_utils import load_json, write_artifact

TEMPLATE = HardTargetBranchTemplate(
    branch_key="dengue_ns2b_ns3_protease_review",
    target_id="Dengue NS2B-NS3 protease",
    branch_label="dengue_ns2b_ns3_protease_review_branch",
    branch_state="operator_review_ready_default_lane_closed",
    packet_scope="partner_operator_guarded_stage6_review",
    operator_packet_status="wetlab_dengue_ns2b_ns3_protease_operator_packet_ready",
    branch_summary_status="wetlab_dengue_ns2b_ns3_protease_review_branch_summary_ready",
    ...
    default_lane_policy="keep_default_closed_guarded_gate45_review_only",
    branch_mode="guarded_operator_review",
    branch_summary_next_step="Review Dengue NS2B-NS3 protease through the guarded gate4.5 branch summary, keep the default lane closed, and do not reopen the default lane until the guarded review is explicitly resolved.",
    operator_packet_next_step="Use the Dengue NS2B-NS3 protease operator packet as the guarded stage6 review unit, keep the default lane closed, and require explicit review before any reopen decision.",
    operator_packet_surface_label="dengue_ns2b_ns3_protease_operator_packet",
)
...
DEFAULT_OUT_MD = "runs/wetlab_dengue_ns2b_ns3_protease_operator_packet_current.md"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the Dengue NS2B-NS3 protease operator packet.")
...
def main() -> None:
    ...
    write_artifact(args.out_md, "Wet-Lab Dengue NS2B-NS3 Protease Operator Packet", payload)
