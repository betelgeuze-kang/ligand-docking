...
def build_priority_targets(
    *,
    ...
    feature_csv: str = "",
    feature_topk: int = 8,
    feature_target_col: str = "target",
    feature_rmsd_col: str = "auto",
    feature_violations_col: str = "auto",
    feature_control_prefix: str = "control_",
    feature_min_control_levels: float = 2.0,
    out_csv: str,
    out_json: str,
) -> Dict[str, Any]:
