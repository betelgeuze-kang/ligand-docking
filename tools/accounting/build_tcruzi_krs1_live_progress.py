...
DEFAULT_OUT_MD = "runs/tcruzi_krs1_live_progress_current.md"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Write the canonical T. cruzi KRS1 live-progress artifact.")
...
def main() -> None:
    ...
    write_artifact(DEFAULT_OUT_MD, "T. cruzi KRS1 Live Progress", payload)
