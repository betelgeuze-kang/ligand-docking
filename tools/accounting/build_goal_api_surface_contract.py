...
def build_goal_api_surface_contract(*, root: str | Path = ".") -> dict[str, Any]:
    ...
    rows = [
        ...
        _row(
            ...
            "api/goal.py",
            "Operators need one API family for status, readiness, priority queue, Developer Preview gates, public benchmark receipts, actions, release decision, burndown, and API contract inspection.",
        ),
        _row(
