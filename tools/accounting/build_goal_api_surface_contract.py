...
REQUIRED_STATUS_KEYS = {
    ...
    "competition_benchmark_rollup_artifact_path",
    "competition_benchmark_cameo_api_dependency_ready",
    "competition_benchmark_cameo_receiver_smoke_ready",
    "competition_benchmark_cameo_format_validation_ready",
    "competition_benchmark_cameo_model1_selection_ready",
    "competition_benchmark_cameo_dry_run_handoff_ready",
    "competition_benchmark_cameo_validation_status",
    "competition_benchmark_cameo_validation_next_action",
    "competition_benchmark_cameo_official_results_used",
    "competition_benchmark_cameo_official_intake_row_count",
    ...
    "competition_benchmark_cameo_official_rejected_result_count",
    "competition_benchmark_cameo_official_model1_result_ready",
    "competition_benchmark_cameo_official_blocker_count",
    "competition_benchmark_cameo_official_blocker_codes",
    "competition_benchmark_cameo_official_required_column_count",
    ...
    "competition_benchmark_cameo_official_native_local_accuracy_used",
    "competition_benchmark_cameo_official_external_state_mutated",
    "competition_benchmark_cameo_official_next_action",
    "competition_benchmark_casp_strict_blind_first_slot_ready",
    "competition_benchmark_casp_strict_blind_blocked_check_count",
    "competition_benchmark_casp_strict_blind_next_action",
    "competition_benchmark_casp_winner_band_unblocked_count",
    "competition_benchmark_casp_winner_band_total_count",
    "competition_benchmark_casp16_ligand_source_manifest_status",
    "competition_benchmark_casp16_ligand_source_manifest_ready",
    "competition_benchmark_casp16_ligand_materialization_ready",
    "competition_benchmark_casp16_ligand_scorecard_ready",
    "competition_benchmark_casp16_ligand_competition_credibility_ready",
    "competition_benchmark_casp16_ligand_raw_data_committed",
    "competition_benchmark_casp16_ligand_raw_data_git_tracked_file_count",
    "competition_benchmark_casp16_ligand_pose_target_count",
    "competition_benchmark_casp16_ligand_affinity_target_count",
    "competition_benchmark_casp16_ligand_next_action",
    "competition_benchmark_bm5_capri_complex_source_manifest_status",
    "competition_benchmark_bm5_complex_benchmark_ready",
    "competition_benchmark_capri_score_set_ready",
    "competition_benchmark_bm5_capri_complex_competition_credibility_ready",
    "competition_benchmark_bm5_capri_complex_raw_data_committed",
    ...
    "competition_benchmark_package_b_refine_tier_work_order_apply_ready",
