...
DEFAULT_RUNTIME_EVENT_JSON = "runs/wetlab_next3_runtime_event_current.json"
DEFAULT_RUNTIME_RUNBOOK_JSON = "runs/wetlab_next3_runtime_runbook_current.json"
DEFAULT_EVENT_LOG = "runs/wetlab_next3_runtime_event_log.jsonl"
DEFAULT_OUT_MD = "runs/wetlab_next3_execution_console_current.md"
...
def build_payload(
    ...
    return {
        "summary": {
            "status": "wetlab_next3_execution_console_ready",
            ...
            "next_required_step": "If Cruzain is still only blocked_on_previous_review, finish priority3 first. Otherwise follow the latest gate state shown here and only advance the next serialized target when the upstream result is resolved.",
        },
        "structured": {
...
def main() -> None:
    ...
    write_artifact(DEFAULT_OUT_MD, "Wet-Lab Next3 Execution Console", payload)
