...
STEP_SPECS: list[tuple[str, list[str], str]] = [
    ("cruzain_run_record", ["tools/build_cruzain_run_record.py"], "runs/cruzain_run_record_current.json"),
    ("cruzain_run_status", ["tools/build_cruzain_run_status.py"], "runs/cruzain_run_status_current.json"),
    ("plpro_result_review", ["tools/build_sarscov2_plpro_result_review.py"], "runs/sarscov2_plpro_result_review_current.json"),
    ("plpro_run_record", ["tools/build_sarscov2_plpro_run_record.py"], "runs/sarscov2_plpro_run_record_current.json"),
