...
DEFAULT_LOG_PATH = ROOT / "runs/wetlab_final2_runtime_event_log.jsonl"
...
def apply_and_log_event(*, target: str, event: str, python_bin: str, active_stage_label: str = "", decision_case: str = "", action: str = "", started_at: str = "", updated_at: str = "", completed_at: str = "", notes: str = "", log_path: Path = DEFAULT_LOG_PATH) -> dict[str, Any]:
    ...
    write_artifact(runtime_event_mod.DEFAULT_OUT_MD, "Wet-Lab Final2 Runtime Event", payload)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Apply and log a final2 runtime event, then rebuild the execution console.")
