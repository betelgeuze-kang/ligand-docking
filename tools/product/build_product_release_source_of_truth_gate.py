...
DEFAULT_STATUS_SPECS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "required_text_exact_fields": {
            ...
            "production_inference_actionable_blocker_artifact": "runs/residual_force_gpu_worker_return_receipt_current.json",
        },
    },
    {
        ...
        "required_int_exact_fields": {
            ...
            "trained_model_checkpoint_count": 1,
            "registry_promotion_upstream_acceptance_ready": 0,
            "post_return_promotion_ladder_blocked_stage_count": 7,
        },
        "required_text_exact_fields": {
            "default_residual_mode": "shadow",
