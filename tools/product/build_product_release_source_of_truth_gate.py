...
DEFAULT_STATUS_SPECS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "required_int_exact_fields": {
            ...
            "selected_sidecar_ready": 0,
            "production_training_data_ready": 0,
            "registry_promotion_upstream_acceptance_ready": 0,
            "production_inference_acceptance_blocked_stage_count": 4,
        },
        "required_text_exact_fields": {
            "default_residual_mode": "shadow",
            "production_inference_actionable_blocker_stage_id": "force_derivation_acceptance",
            "production_inference_actionable_blocker_check_id": "delta_force_derivation_validation_ready",
            "production_inference_actionable_blocker_artifact": "runs/residual_force_derivation_validation_current.json",
        },
    },
    {
        ...
        "required_int_exact_fields": {
            ...
            "trained_model_checkpoint_count": 1,
            "registry_promotion_upstream_acceptance_ready": 0,
            "post_return_promotion_ladder_blocked_stage_count": 6,
        },
        "required_text_exact_fields": {
            "default_residual_mode": "shadow",
            "first_blocked_stage_id": "force_derivation_validation",
            "first_blocked_stage_artifact": "runs/residual_force_derivation_validation_current.json",
            "first_blocked_stage_ready_key": "delta_force_derivation_validation_ready",
        },
    },
    {
