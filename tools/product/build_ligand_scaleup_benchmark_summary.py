...
def _scaleup_repair_packet(
    *,
    ...
    return {
        ...
        "diagnostic_command": "python3 tools/gpcr_replay/build_gpcr_100k_failure_analysis.py",
        "next_command": (
            "python3 tools/gpcr_replay/build_gpcr_apply_safe_endpoint.py && "
            "python3 tools/product/build_gpcr_residual_chembl50_v4_endpoint_note.py"
        ),
        "next_required_step": (
