...
def _stage_proc_lines(stage_id: str, all_proc_lines: list[str], run_root: Path | None) -> list[str]:
    hints = {
        ...
        "pilot_100k": ("product/run_ligand_scaleup_100k_pilot_current.py",),
...
def build_suite_payload(args: argparse.Namespace) -> dict[str, Any]:
    ...
    pattern = (
        "product/run_ligand_scaleup_suite_current.py|run_ligand_speedpack_ab_current.py|"
        "product/run_ligand_scaleup_100k_pilot_current.py|run_ligand_scaleup_1m_pilot_current.py|"
