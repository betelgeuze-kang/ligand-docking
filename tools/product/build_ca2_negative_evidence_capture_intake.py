...
def main() -> None:
    ...
    if payload["summary"]["intake_applied"]:
        ...
        _run("product/build_ca2_next_verification_slice.py")
        _run("product/build_ca2_evidence_closure_day_plan.py")
        _run("product/build_ca2_review_only_negative_packet.py")
        _run("product/build_ca2_reviewer_workbench.py")
        _run("product/build_ca2_negative_reviewer_draft_packet.py")
        _run(
            "product/build_ca2_evidence_closure_commit_packet.py",
            "--existing-sheet-csv",
        ...
        _run("product/build_ca2_negative_review_day_plan.py")
        _run("product/build_ca2_pending_burndown_console.py")
