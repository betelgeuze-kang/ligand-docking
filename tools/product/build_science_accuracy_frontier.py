...
def build_science_accuracy_frontier(
    *,
    ...
    coordinate_intake_payload, coordinate_intake_present = _read_json(
    ...
    public_statistical_support_coordinate_intake_ready = bool(
        coordinate_intake_present
        and coordinate_intake.get("status")
        == "refine_tier_public_benchmark_statistical_support_coordinate_intake_ready"
        and coordinate_intake.get("coordinate_intake_ready") is True
    )
    ...
    public_statistical_support_metric_source_payload_operator_receipt_ready = bool(
        metric_source_payload_operator_receipt_present
    ...
    if (
        ...
        if (
            ...
            if not coordinate_intake_present:
                blockers.append(
                    "openmm_schrodinger_public_benchmark_statistical_support_coordinate_intake_missing"
                )
            elif not public_statistical_support_coordinate_intake_ready:
                blockers.append(
                    "openmm_schrodinger_public_benchmark_statistical_support_coordinate_intake_not_ready"
                )
    ...
    summary = {
        ...
        "public_benchmark_statistical_support_coordinate_intake_present": coordinate_intake_present,
        "public_benchmark_statistical_support_coordinate_intake_ready": (
            public_statistical_support_coordinate_intake_ready
        ),
        "public_benchmark_statistical_support_coordinate_intake_status": str(
            coordinate_intake.get("status", "")
        ),
        "public_benchmark_statistical_support_coordinate_intake_row_count": _int(
            coordinate_intake.get("coordinate_intake_row_count")
        ),
        "public_benchmark_statistical_support_coordinate_intake_artifact_present_row_count": _int(
            coordinate_intake.get("coordinate_intake_artifact_present_row_count")
        ),
        "public_benchmark_statistical_support_coordinate_intake_missing_row_count": _int(
            coordinate_intake.get("coordinate_intake_missing_row_count")
        ),
        "public_benchmark_statistical_support_coordinate_intake_suggested_public_url_row_count": _int(
            coordinate_intake.get("coordinate_intake_suggested_public_url_row_count")
        ),
        "public_benchmark_statistical_support_coordinate_intake_suggested_local_path_row_count": _int(
            coordinate_intake.get("coordinate_intake_suggested_local_path_row_count")
        ),
        "public_benchmark_statistical_support_coordinate_intake_suggested_local_path_candidate_count": _int(
            coordinate_intake.get("coordinate_intake_suggested_local_path_candidate_count")
        ),
        "public_benchmark_statistical_support_coordinate_intake_suggested_local_path_present_count": _int(
            coordinate_intake.get("coordinate_intake_suggested_local_path_present_count")
        ),
        "public_benchmark_statistical_support_coordinate_intake_suggested_local_path_present_target_count": _int(
            coordinate_intake.get("coordinate_intake_suggested_local_path_present_target_count")
        ),
        "public_benchmark_statistical_support_coordinate_intake_suggested_local_path_missing_target_count": _int(
            coordinate_intake.get("coordinate_intake_suggested_local_path_missing_target_count")
        ),
        "public_benchmark_statistical_support_coordinate_intake_expected_archive_member_example_count": _int(
            coordinate_intake.get("coordinate_intake_expected_archive_member_example_count")
        ),
        "public_benchmark_statistical_support_coordinate_intake_operator_review_required_row_count": _int(
            coordinate_intake.get("coordinate_intake_operator_review_required_row_count")
        ),
        "public_benchmark_statistical_support_coordinate_intake_coordinate_validation_pass_row_count": _int(
            coordinate_intake.get("coordinate_validation_pass_row_count")
        ),
        "public_benchmark_statistical_support_coordinate_intake_coordinate_validation_blocked_row_count": _int(
            coordinate_intake.get("coordinate_validation_blocked_row_count")
        ),
        "public_benchmark_statistical_support_coordinate_intake_coordinate_validation_missing_row_count": _int(
            coordinate_intake.get("coordinate_validation_missing_row_count")
        ),
        ...
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_ready": (
            public_statistical_support_metric_source_payload_operator_receipt_ready
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_status": str(
            metric_source_payload_operator_receipt.get("status", "")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_csv_present": bool(
            metric_source_payload_operator_receipt.get("receipt_csv_present") is True
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_row_count": _int(
            metric_source_payload_operator_receipt.get("receipt_row_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_required_template_count": _int(
            metric_source_payload_operator_receipt.get("required_template_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_pass_row_count": _int(
            metric_source_payload_operator_receipt.get("pass_row_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_blocked_row_count": _int(
            metric_source_payload_operator_receipt.get("blocked_row_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_approved_payload_count": _int(
            metric_source_payload_operator_receipt.get("approved_payload_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_template_fill_ready_row_count": _int(
            metric_source_payload_operator_receipt.get("template_fill_ready_row_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_coordinate_validation_pass_payload_row_count": _int(
            metric_source_payload_operator_receipt.get("coordinate_validation_pass_payload_row_count")
        ),
        ...
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_operator_review_surface_ready_count": _int(
            metric_source_payload_operator_receipt.get("operator_review_surface_ready_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_operator_review_surface_blocked_count": _int(
            metric_source_payload_operator_receipt.get("operator_review_surface_blocked_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_metric_source_artifact_path_present_count": _int(
            metric_source_payload_operator_receipt.get("metric_source_artifact_path_present_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_required_metric_input_artifact_list_present_count": _int(
            metric_source_payload_operator_receipt.get("required_metric_input_artifact_list_present_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_required_metric_input_artifact_sha256_list_present_count": _int(
            metric_source_payload_operator_receipt.get(
                "required_metric_input_artifact_sha256_list_present_count"
            )
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_required_metric_input_artifact_sha256_list_complete_count": _int(
            metric_source_payload_operator_receipt.get(
                "required_metric_input_artifact_sha256_list_complete_count"
            )
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_required_metric_source_payload_fields_present_count": _int(
            metric_source_payload_operator_receipt.get("required_metric_source_payload_fields_present_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_external_engine_calls_zero_count": _int(
            metric_source_payload_operator_receipt.get("external_engine_calls_zero_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_receipt_manual_field_pending_count": _int(
            metric_source_payload_operator_receipt.get("receipt_manual_field_pending_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_receipt_metric_value_pending_count": _int(
            metric_source_payload_operator_receipt.get("receipt_metric_value_pending_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_receipt_method_pending_count": _int(
            metric_source_payload_operator_receipt.get("receipt_method_pending_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_receipt_input_artifacts_reviewed_pending_count": _int(
            metric_source_payload_operator_receipt.get("receipt_input_artifacts_reviewed_pending_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_receipt_input_artifact_sha256s_reviewed_pending_count": _int(
            metric_source_payload_operator_receipt.get(
                "receipt_input_artifact_sha256s_reviewed_pending_count"
            )
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_receipt_metric_source_artifact_reviewed_pending_count": _int(
            metric_source_payload_operator_receipt.get(
                "receipt_metric_source_artifact_reviewed_pending_count"
            )
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_receipt_payload_schema_reviewed_pending_count": _int(
            metric_source_payload_operator_receipt.get("receipt_payload_schema_reviewed_pending_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_receipt_license_ok_pending_count": _int(
            metric_source_payload_operator_receipt.get("receipt_license_ok_pending_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_receipt_operator_id_pending_count": _int(
            metric_source_payload_operator_receipt.get("receipt_operator_id_pending_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_receipt_reviewed_at_utc_pending_count": _int(
            metric_source_payload_operator_receipt.get("receipt_reviewed_at_utc_pending_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_receipt_approval_token_pending_count": _int(
            metric_source_payload_operator_receipt.get("receipt_approval_token_pending_count")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_payload_write_allowed": bool(
            metric_source_payload_operator_receipt.get("payload_write_allowed") is True
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_canonical_intake_promotion_allowed": bool(
            metric_source_payload_operator_receipt.get("canonical_intake_promotion_allowed") is True
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_claim_promotion_allowed": bool(
            metric_source_payload_operator_receipt.get("claim_promotion_allowed") is True
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_external_state_mutated": bool(
            metric_source_payload_operator_receipt.get("external_state_mutated") is True
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_first_blocked_template_id": str(
            metric_source_payload_operator_receipt.get("first_blocked_template_id", "")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_first_blocked_target_id": str(
            metric_source_payload_operator_receipt.get("first_blocked_target_id", "")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_first_blocked_pose_id": str(
            metric_source_payload_operator_receipt.get("first_blocked_pose_id", "")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_first_blocked_metric_name": str(
            metric_source_payload_operator_receipt.get("first_blocked_metric_name", "")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_most_common_row_blocker": str(
            metric_source_payload_operator_receipt.get("most_common_row_blocker", "")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_approval_token_required": str(
            metric_source_payload_operator_receipt.get("approval_token_required", "")
        ),
        "public_benchmark_statistical_support_metric_source_payload_operator_receipt_blocker_count": _int(
            metric_source_payload_operator_receipt.get("blocker_count")
        ),
    ...
    return {
        ...
        "source_artifacts": {
            ...
            "refine_tier_public_benchmark_statistical_support_coordinate_intake": str(
                public_benchmark_statistical_support_coordinate_intake_json
            ),
...
def _write_markdown(path_like: str | Path, payload: dict[str, Any]) -> None:
    ...
    lines = [
        ...
        "- public_benchmark_statistical_support_coordinate_intake_ready/row/missing: "
        f"`{summary['public_benchmark_statistical_support_coordinate_intake_ready']}/"
        f"{summary['public_benchmark_statistical_support_coordinate_intake_row_count']}/"
        f"{summary['public_benchmark_statistical_support_coordinate_intake_missing_row_count']}`",
        "- public_benchmark_statistical_support_coordinate_intake_local_path_candidates/present/present_targets/missing_targets: "
        f"`{summary['public_benchmark_statistical_support_coordinate_intake_suggested_local_path_candidate_count']}/"
        f"{summary['public_benchmark_statistical_support_coordinate_intake_suggested_local_path_present_count']}/"
        ...
        "- public_benchmark_statistical_support_metric_source_payload_receipt_ready/blocked: "
