...
def build_payload(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        ...
        "summary": {
            ...
            "next_required_step": "Freeze a non-placeholder PXR core ligand_id ledger, then fill provenance/meta/split fields consistently across the three packet tables.",
        },
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build a PXR core ligand ledger from reference/split/meta packets.")
    parser.add_argument("--reference-csv", default="config/ligand_binding_reference_blind_pxr_nr1i2_v1.csv")
    parser.add_argument("--eval-split-csv", default="config/ligand_eval_splits_blind_pxr_nr1i2_v1.csv")
    parser.add_argument("--ligand-meta-csv", default="config/ligand_meta_blind_pxr_nr1i2_v1.csv")
    parser.add_argument("--out-json", default="runs/pxr_core_ligand_ledger_current.json")
    parser.add_argument("--out-csv", default="runs/pxr_core_ligand_ledger_current.csv")
    parser.add_argument("--out-md", default="runs/pxr_core_ligand_ledger_current.md")
