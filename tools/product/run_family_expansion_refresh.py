...
def main() -> None:
    steps = [
        ("ca2_capture_sheet_seed", [sys.executable, _script("product/build_ca2_negative_evidence_capture_sheet.py")]),
        ("ca2_public_negative_overlay", [sys.executable, _script("product/build_ca2_public_negative_evidence_overlay.py")]),
        ("ca2_capture_sheet", [sys.executable, _script("product/build_ca2_negative_evidence_capture_sheet.py")]),
        ("ca2_capture_intake", [sys.executable, _script("product/build_ca2_negative_evidence_capture_intake.py")]),
        ("pxr_capture_sheet_seed", [sys.executable, _script("product/build_pxr_unresolved_evidence_capture_sheet.py")]),
        ("pxr_public_overlay", [sys.executable, _script("product/build_pxr_public_evidence_overlay.py")]),
        ("pxr_capture_sheet", [sys.executable, _script("product/build_pxr_unresolved_evidence_capture_sheet.py")]),
        ("pxr_capture_intake", [sys.executable, _script("tools/product/build_pxr_unresolved_evidence_capture_intake.py")]),
        ("aqp1_external_seed", [sys.executable, _script("product/build_aqp1_external_evidence_seed.py")]),
        ("aqp1_fill_queue", [sys.executable, _script("product/build_aqp1_packet_fill_queue.py")]),
        ("aqp1_workbook", [sys.executable, _script("product/build_aqp1_packet_replacement_workbook.py")]),
        ("aqp1_quant_sheet", [sys.executable, _script("product/build_aqp1_quantitative_binding_capture_sheet.py")]),
        ("aqp1_quant_intake", [sys.executable, _script("product/build_aqp1_quantitative_binding_capture_intake.py")]),
        ("aqp1_quantitative_provenance_packet", [sys.executable, _script("product/build_aqp1_quantitative_provenance_packet.py")]),
        ("aqp1_first_wave_source_confirmation_packet", [sys.executable, _script("product/build_aqp1_first_wave_source_confirmation_packet.py")]),
        ("aqp1_candidate_ledger", [sys.executable, _script("product/build_aqp1_candidate_evidence_ledger.py")]),
        ("aqp1_local_note", [sys.executable, _script("product/build_aqp1_local_evidence_note.py")]),
        ("aqp1_manual_queue", [sys.executable, _script("product/build_aqp1_manual_review_queue.py")]),
        ("aqp1_next_slice", [sys.executable, _script("product/build_aqp1_next_verification_slice.py")]),
        ("aqp1_candidate_verdict_sheet", [sys.executable, _script("product/build_transporter_candidate_verdict_sheet.py"), "--family", "aqp1"]),
        ("aqp1_binder_verdict_update_sheet", [sys.executable, _script("product/build_transporter_binder_verdict_update_sheet.py"), "--family", "aqp1"]),
        ("aqp1_binder_brief", [sys.executable, _script("product/build_aqp1_binder_review_brief.py")]),
        ("aqp1_apply_draft", [sys.executable, _script("product/build_aqp1_manual_verdict_apply_draft.py")]),
        ("aqp1_negative_handoff", [sys.executable, _script("product/build_aqp1_negative_review_handoff_packet.py")]),
        ("aqp1_negative_source_exclusion", [sys.executable, _script("product/build_aqp1_negative_source_exclusion_packet.py")]),
        ("aqp1_negative_slot_closure", [sys.executable, _script("product/build_aqp1_negative_slot_closure_packet.py")]),
        ("aqp1_negative_acquisition", [sys.executable, _script("product/build_aqp1_negative_evidence_acquisition_packet.py")]),
        ("aqp1_negative_confirmation", [sys.executable, _script("product/build_aqp1_negative_evidence_confirmation_packet.py")]),
        ("aqp1_negative_slot_resolution", [sys.executable, _script("product/build_aqp1_negative_slot_resolution_packet.py")]),
        ("aqp1_negative_candidate_frontier", [sys.executable, _script("product/build_aqp1_negative_candidate_frontier_packet.py")]),
        ("aqp1_negative_frontier_resolution", [sys.executable, _script("product/build_aqp1_negative_frontier_resolution_packet.py")]),
        ("aqp1_negative_primary_probe", [sys.executable, _script("product/build_aqp1_negative_primary_probe_packet.py")]),
        ("aqp1_negative_exact_source_outcome", [sys.executable, _script("product/build_aqp1_negative_exact_source_outcome_packet.py")]),
        ("aqp1_negative_primary_probe_resolution", [sys.executable, _script("product/build_aqp1_negative_primary_probe_resolution_packet.py")]),
        ("aqp1_manual_handoff", [sys.executable, _script("product/build_aqp1_manual_verdict_handoff_packet.py")]),
        ("aqp1_reviewer_workbench", [sys.executable, _script("product/build_aqp1_reviewer_workbench.py")]),
        ("aqp1_p0_plan", [sys.executable, _script("product/build_aqp1_p0_packet_plan.py")]),
        ("transporter_wave_notes", [sys.executable, _script("product/build_transporter_wave_verdict_notes.py")]),
        ("transporter_wave_decision", [sys.executable, _script("product/build_transporter_wave_decision.py")]),
        ("transporter_apply_status", [sys.executable, _script("product/build_transporter_apply_draft_status.py")]),
        ("transporter_donor_blocker", [sys.executable, _script("product/build_transporter_donor_policy_blocker_packet.py")]),
        ("transporter_membrane_readiness", [sys.executable, _script("product/build_transporter_membrane_readiness.py")]),
        ("transporter_fit_donor_policy", [sys.executable, _script("product/build_transporter_fit_donor_policy_decision.py")]),
        ("transporter_donor_reopen", [sys.executable, _script("product/build_transporter_donor_policy_reopen_checklist.py")]),
        ("transporter_blocker_decomposition", [sys.executable, _script("product/build_transporter_authoritative_apply_blocker_decomposition.py")]),
        ("transporter_binder_slot_ledger", [sys.executable, _script("product/build_transporter_binder_slot_ledger.py")]),
        ("glut1_negative_handoff", [sys.executable, _script("product/build_glut1_negative_review_handoff_packet.py")]),
        ("transporter_negative_day_plan", [sys.executable, _script("product/build_transporter_negative_reviewer_day_plan.py")]),
        ("transporter_negative_target_packets", [sys.executable, _script("build_transporter_negative_evidence_target_packets.py")]),
        ("transporter_reviewer_day_plan", [sys.executable, _script("product/build_transporter_reviewer_day_plan.py")]),
        ("transporter_reviewer_day2_console", [sys.executable, _script("product/build_transporter_reviewer_day2_console.py")]),
        ("transporter_verdict_summary", [sys.executable, _script("product/build_transporter_verdict_summary.py")]),
        ("transporter_verdict_packets", [sys.executable, _script("product/build_transporter_manual_verdict_packets.py")]),
        ("transporter_blocker_sheet", [sys.executable, _script("product/build_transporter_blocker_capture_sheet.py")]),
        ("transporter_blocker_intake", [sys.executable, _script("product/build_transporter_blocker_capture_intake.py")]),
        ...
        ("aqp1_follow_on_blocker_decomposition", [sys.executable, _script("product/build_aqp1_follow_on_blocker_decomposition.py")]),
        ...
        ("glut1_second_wave_seed_fill_draft", [sys.executable, _script("product/build_glut1_second_wave_seed_row_fill_draft.py")]),
        ("glut1_second_wave_seed_sync_preview", [sys.executable, _script("product/build_glut1_second_wave_seed_row_sync_apply_preview.py")]),
        (
        ...
        (
            ...
            [
                sys.executable,
                _script("product/build_glut1_second_wave_seed_row_fill_draft.py"),
                "--packet-step",
                "core_binder_02",
                "--seed-packet-json",
        ...
        (
            ...
            [
                sys.executable,
                _script("product/build_glut1_second_wave_seed_row_sync_apply_preview.py"),
                "--packet-step",
                "core_binder_02",
        ...
        ("transporter_apply_status_post_stage", [sys.executable, _script("product/build_transporter_apply_draft_status.py")]),
        ("transporter_seed_row_promotion_board_post_stage", [sys.executable, _script("product/build_transporter_seed_row_promotion_board.py")]),
        ("transporter_seed_execution", [sys.executable, _script("build_transporter_seed_row_execution_packet.py")]),
        ("transporter_operator_console", [sys.executable, _script("product/build_transporter_operator_console.py")]),
        ...
        ("pxr_literature_candidate_overlay", [sys.executable, _script("product/build_pxr_literature_candidate_overlay.py")]),
        ("family_evidence_investigator_packet", [sys.executable, _script("build_family_evidence_investigator_packet.py")]),
        ("pxr_exact_source_confirmation_packet", [sys.executable, _script("product/build_pxr_exact_source_confirmation_packet.py")]),
        ("pxr_conflict_resolver_packet", [sys.executable, _script("product/build_pxr_conflict_resolver_packet.py")]),
        ("pxr_quantitative_provenance_packet", [sys.executable, _script("product/build_pxr_quantitative_provenance_packet.py")]),
        ...
        (
            ...
            [sys.executable, _script("wetlab/build_wetlab_tcruzi_pde_bindingdb_similarity_seed_packet.py")],
        ),
        (
            "wetlab_tcruzi_pde_external_geometry_stability_rescue_queue",
            [sys.executable, _script("wetlab/build_wetlab_tcruzi_pde_external_geometry_stability_rescue_queue.py")],
        ),
        (
            "wetlab_tcruzi_pde_translation_evidence_probe",
            [
                sys.executable,
                _script("wetlab/probe_wetlab_tcruzi_pde_translation_evidence.py"),
                "--out-json",
        ...
        (
            ...
            [sys.executable, _script("wetlab/build_wetlab_tcruzi_pde_ligand_atomization_gap_packet.py")],
        ),
        (
            "wetlab_tcruzi_pde_atomized_ligand_draft_packet",
            [sys.executable, _script("wetlab/build_wetlab_tcruzi_pde_atomized_ligand_draft_packet.py")],
        ),
        ...
        ("cross_family_shadow", [sys.executable, _script("product/build_cross_family_residual_shadow_layer.py")]),
        ...
        ("aqp1_functional_kcal_surrogate_packet_final", [sys.executable, _script("product/build_aqp1_functional_kcal_surrogate_packet.py")]),
        ("ca2_pxr_review_policy_closure_gate_final", [sys.executable, _script("product/build_ca2_pxr_review_policy_closure_gate.py")]),
