...
DEFAULT_OUT_MD = 'runs/lrrk2_live_progress_current.md'


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Write the canonical LRRK2 live-progress artifact.')
...
if __name__ == '__main__':
    args = parse_args()
    write_artifact(DEFAULT_OUT_MD, 'LRRK2 Live Progress', build_payload(load_json(args.launch_json), status=args.status, active_stage_label=args.active_stage_label, started_at=args.started_at, updated_at=args.updated_at, notes=args.notes))
