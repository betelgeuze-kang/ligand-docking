...
DEFAULT_OUT_MD = "runs/tcruzi_pde_live_progress_current.md"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Write the canonical T. cruzi PDE live-progress artifact.")
...
def main() -> None:
    ...
    write_artifact(DEFAULT_OUT_MD, "T. cruzi PDE Live Progress", payload)
