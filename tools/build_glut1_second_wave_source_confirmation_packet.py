...
ROW_OVERRIDES: dict[str, dict[str, Any]] = {
    ...
    "core_binder_02": {
        ...
        "evidence_signal": (
            "Confirmed human GLUT1 functional inhibitor / transport blocker with exact target-pair ChEMBL activities "
            "(IC50 10.9 uM; >10 uM) and human RBC transport inhibition; no direct quantitative binding constant or kcal recovered."
        ),
        "public_provenance_status": "exact_human_glut1_activity_present_nonbinding",
        "public_provenance_signal": "exact_target_pair_activity_present_leave_kcal_blank",
        "assay_type_honesty": "human_functional_transport_inhibition_not_direct_binding",
        ...
        "representative_activity": "IC50=10.9 uM; IC50>10 uM; literature Ki(app)=6 uM",
...
def build_payload(queue_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    summary = {
        ...
        "next_required_step": (
            ...
            "then core_binder_02 (WZB117) as the exact-target-pair functional inhibitor row, then core_binder_03 (STF-31) as the review-only "
            "human GLUT1 functional anchor with NAMPT / dual-action caveats. Leave replacement_reference_binding_kcal_mol blank."
        ),
    }
