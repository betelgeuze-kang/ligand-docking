...
- manifest signature: `84d276a4c723246b61dd5078319f1bb6536bea5c2d90ab8bc7fcf32d4ea9647b`
- timestamp manifest: `casp17/current_escrow_external_timestamp_packet/TIMESTAMP_MANIFEST.csv`
- first ready/blocked: `H1344`/`-` `-`

## Timestamp Manifest Rows

| target | status | action | upload | urgency | sha256 | escrow md | blockers |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `H1344` | `ready_for_external_timestamp` | `timestamp_now_expiring_today` | `upload_ready_expiring_today` | `today` | `4a7cb5d75954954f` | `casp17/current_prospective_strict_blind_escrow/h1344/ESCROW.md` | - |
| `H2321` | `ready_for_external_timestamp` | `timestamp_now_expiring_today` | `upload_ready_expiring_today` | `today` | `8e1760f7d853d99c` | `casp17/current_prospective_strict_blind_escrow/h2321/ESCROW.md` | - |
...
| `H1348` | `ready_for_external_timestamp` | `timestamp_now_expiring_soon` | `upload_ready_expiring_soon` | `soon` | `90c995d19f4ff0b4` | `casp17/current_prospective_strict_blind_escrow/h1348/ESCROW.md` | - |
| `H1349` | `ready_for_external_timestamp` | `timestamp_now_expiring_soon` | `upload_ready_expiring_soon` | `soon` | `a65d6a6f47de74a7` | `casp17/current_prospective_strict_blind_escrow/h1349/ESCROW.md` | - |
...
| `H2319` | `ready_for_external_timestamp` | `timestamp_for_retrospective_proof_only` | `blocked_official_deadline_expired` | `-` | `c278eff01708e2e0` | `casp17/current_prospective_strict_blind_escrow/h2319/ESCROW.md` | - |
...
| `T1342` | `ready_for_external_timestamp` | `timestamp_for_retrospective_proof_only` | `blocked_official_deadline_expired` | `-` | `9e3a276fc923414a` | `casp17/current_prospective_strict_blind_escrow/t1342/ESCROW.md` | - |
