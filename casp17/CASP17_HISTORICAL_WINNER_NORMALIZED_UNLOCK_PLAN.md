...
- generated: `2026-06-01T20:49:56+09:00`
...
| ---: | --- | --- | --- | ---: | ---: | ---: | --- | --- |
| 1 | `close_first_source_request` | `strict_blind_internal_prediction_source` | `unlock_blocked` | 0 | 9 | 9 | `prediction_not_before_native` | attach a prediction artifact created before the authoritative native release date, with timestamp and no-leak evidence |
