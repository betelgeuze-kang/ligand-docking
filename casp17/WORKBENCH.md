...
- competitive target identity clearance replacement queue: `blocked_replacement_candidates` targets/candidates `2/8` ready/missing-prediction/current-collision/source-repair `0/2/4/2`
- competitive target identity clearance replacement source repair: `ready_for_validation_scorecard` candidates/ready/md `4/1/4` source-ready/predict/validate/sequence/cancelled/collision `0/0/1/0/1/2`
...
| `competitive_floor_target_identity_clearance_replacement_queue` | `blocked_replacement_candidates` | 0 | 8 | 8 | `casp17/casp17_competitive_floor_target_identity_clearance_replacement_queue_current.json` | repair missing local evidence before moving this candidate into clearance workorders | `replacement_targets:2,ready:0,missing_prediction:2,current_collision:4,source_repair:2` |
| `competitive_floor_target_identity_clearance_replacement_source_repair` | `ready_for_validation_scorecard` | 1 | 3 | 4 | `casp17/casp17_competitive_floor_target_identity_clearance_replacement_source_repair_current.json` | run validation and scorecard generation for this candidate | `source_ready:0,ready_prediction:0,ready_validation:1,awaiting_sequence:0,cancelled:1,current_collision:2,md:4` |
