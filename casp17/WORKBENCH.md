...
- generated: `2026-05-28T03:59:39+09:00`
...
- historical seed calibration candidates: `operator_calibration_review_required` seeds/ledgers/models `15/15/76` top5/selected/rank `15/15/15` native/internal `0/0` ready/review/blocked-selected/open-fields `0/15/0/90` first `HIST_BBA5` `attach native oracle metrics and internal scores before filling calibration fields`
...
| `historical_seed_calibration_candidate_ledgers` | `operator_calibration_review_required` | 0 | 15 | 15 | `casp17/casp17_historical_seed_calibration_candidate_ledgers_current.json` | attach native oracle metrics and internal scores before filling calibration fields | `models:76,top5_ready:15,selected_rank:15,native_metrics:0,internal_scores:0,open_fields:90` |
