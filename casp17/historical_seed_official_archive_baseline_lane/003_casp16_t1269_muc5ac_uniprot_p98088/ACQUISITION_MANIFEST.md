# CASP16 T1269 Official Archive Baseline

- baseline_candidate_id: `official_archive_baseline_003`
- source_candidate_id: `official_archive_source_003`
...
- prediction_tarball_url: `https://predictioncenter.org/download_area/CASP16/predictions/regular/T1269.tar.gz`
- native_structure_file_url: `https://files.rcsb.org/download/9GVQ.pdb`
- prediction/native dates: `2024-07-05 09:20` `2025-02-01`
...
```bash
mkdir -p casp17/historical_seed_official_archive_baseline_lane/003_casp16_t1269_muc5ac_uniprot_p98088/downloads casp17/historical_seed_official_archive_baseline_lane/003_casp16_t1269_muc5ac_uniprot_p98088/models casp17/historical_seed_official_archive_baseline_lane/003_casp16_t1269_muc5ac_uniprot_p98088/native
curl -L -o casp17/historical_seed_official_archive_baseline_lane/003_casp16_t1269_muc5ac_uniprot_p98088/downloads/T1269.tar.gz 'https://predictioncenter.org/download_area/CASP16/predictions/regular/T1269.tar.gz'
curl -L -o casp17/historical_seed_official_archive_baseline_lane/003_casp16_t1269_muc5ac_uniprot_p98088/native/9GVQ.pdb 'https://files.rcsb.org/download/9GVQ.pdb'
```
