# CASP16 T1239v2 Official Archive Baseline

- baseline_candidate_id: `official_archive_baseline_010`
- source_candidate_id: `official_archive_source_010`
...
- prediction_tarball_url: `https://predictioncenter.org/download_area/CASP16/predictions/regular/T1239v2.tar.gz`
...
```bash
mkdir -p casp17/historical_seed_official_archive_baseline_lane/010_casp16_t1239v2_spbeta_intrdf_dna_protein_subunit_of_m1239v2/downloads casp17/historical_seed_official_archive_baseline_lane/010_casp16_t1239v2_spbeta_intrdf_dna_protein_subunit_of_m1239v2/models casp17/historical_seed_official_archive_baseline_lane/010_casp16_t1239v2_spbeta_intrdf_dna_protein_subunit_of_m1239v2/native
curl -L -o casp17/historical_seed_official_archive_baseline_lane/010_casp16_t1239v2_spbeta_intrdf_dna_protein_subunit_of_m1239v2/downloads/T1239v2.tar.gz 'https://predictioncenter.org/download_area/CASP16/predictions/regular/T1239v2.tar.gz'
curl -L -o casp17/historical_seed_official_archive_baseline_lane/010_casp16_t1239v2_spbeta_intrdf_dna_protein_subunit_of_m1239v2/native/9DXD.pdb 'https://files.rcsb.org/download/9DXD.pdb'
```
