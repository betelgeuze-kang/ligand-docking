# CASP16 T1206 Official Archive Baseline

- baseline_candidate_id: `official_archive_baseline_012`
- source_candidate_id: `official_archive_source_012`
...
- prediction_tarball_url: `https://predictioncenter.org/download_area/CASP16/predictions/regular/T1206.tar.gz`
- native_structure_file_url: `https://files.rcsb.org/download/9CP0.pdb`
- prediction/native dates: `2024-06-03 09:21` `2025-02-01`
...
```bash
mkdir -p casp17/historical_seed_official_archive_baseline_lane/012_casp16_t1206_porcine_astrovirus_4_capsid_spike/downloads casp17/historical_seed_official_archive_baseline_lane/012_casp16_t1206_porcine_astrovirus_4_capsid_spike/models casp17/historical_seed_official_archive_baseline_lane/012_casp16_t1206_porcine_astrovirus_4_capsid_spike/native
curl -L -o casp17/historical_seed_official_archive_baseline_lane/012_casp16_t1206_porcine_astrovirus_4_capsid_spike/downloads/T1206.tar.gz 'https://predictioncenter.org/download_area/CASP16/predictions/regular/T1206.tar.gz'
curl -L -o casp17/historical_seed_official_archive_baseline_lane/012_casp16_t1206_porcine_astrovirus_4_capsid_spike/native/9CP0.pdb 'https://files.rcsb.org/download/9CP0.pdb'
```
