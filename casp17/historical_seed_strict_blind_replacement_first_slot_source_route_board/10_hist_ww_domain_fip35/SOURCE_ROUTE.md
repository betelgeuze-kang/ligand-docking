# HIST_WW_DOMAIN_FIP35 First-Slot Source Route

- route: `first_slot_source_route_010`
- status: `in_scope_current_candidate_disqualified_post_native`
- scope/required: `monomer` `monomer`
- allowed for first slot: `False`
- prediction/native dates: `2026-02-19` `2005-11-15`
- external/source/evidence/date/primary actions: `2/0/3/0/0`
