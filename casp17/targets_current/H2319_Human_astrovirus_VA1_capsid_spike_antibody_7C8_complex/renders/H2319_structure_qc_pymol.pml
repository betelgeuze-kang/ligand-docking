...
set internal_gui, 0
viewport 1800, 1200
load "runs/casp17_predictions_model_selected_shape_guarded_coordinate_normalized_current/H2319TS.pdb", casp17_H2319_qc
hide everything, casp17_H2319_qc
remove casp17_H2319_qc and elem H
bg_color 0x08111f
...
show cartoon, casp17_H2319_qc
show sticks, casp17_H2319_qc and not name N+C+O+CA
show spheres, casp17_H2319_qc and name CA
set cartoon_transparency, 0.22, casp17_H2319_qc
set stick_transparency, 0.18, casp17_H2319_qc and not name N+C+O+CA
...
color casp17_qc_base, casp17_H2319_qc
set_color casp17_qc_chain_0, [0.3294, 0.4941, 0.8392]
color casp17_qc_chain_0, casp17_H2319_qc and chain A
set_color casp17_qc_chain_1, [0.7451, 0.3529, 0.3882]
color casp17_qc_chain_1, casp17_H2319_qc and chain B
set_color casp17_qc_chain_2, [0.2549, 0.6078, 0.5412]
color casp17_qc_chain_2, casp17_H2319_qc and chain C
select qc_hotspot_1, (casp17_H2319_qc and chain A and resi 216)
...
label qc_hotspot_1 and name CA, "A:216"
select qc_hotspot_2, (casp17_H2319_qc and chain A and resi 71)
...
label qc_hotspot_2 and name CA, "A:71"
select qc_hotspot_3, (casp17_H2319_qc and chain A and resi 137)
...
label qc_hotspot_3 and name CA, "A:137"
select qc_hotspot_4, (casp17_H2319_qc and chain A and resi 168)
...
label qc_hotspot_4 and name CA, "A:168"
select qc_hotspot_5, (casp17_H2319_qc and chain A and resi 171)
...
label qc_hotspot_5 and name CA, "A:171"
select qc_hotspot_6, (casp17_H2319_qc and chain A and resi 187)
...
label qc_hotspot_6 and name CA, "A:187"
select qc_hotspot_7, (casp17_H2319_qc and chain A and resi 256)
...
label qc_hotspot_7 and name CA, "A:256"
select qc_hotspot_8, (casp17_H2319_qc and chain A and resi 254)
...
label qc_hotspot_8 and name CA, "A:254"
select qc_hotspot_9, (casp17_H2319_qc and chain A and resi 248)
...
label qc_hotspot_9 and name CA, "A:248"
select qc_hotspot_10, (casp17_H2319_qc and chain A and resi 109)
...
label qc_hotspot_10 and name CA, "A:109"
select qc_hotspot_11, (casp17_H2319_qc and chain A and resi 120)
...
select qc_hotspot_12, (casp17_H2319_qc and chain A and resi 188)
...
select qc_hotspot_13, (casp17_H2319_qc and chain A and resi 267)
...
select qc_hotspot_14, (casp17_H2319_qc and chain A and resi 1)
...
select qc_hotspot_15, (casp17_H2319_qc and chain C and resi 101)
...
select qc_hotspot_16, (casp17_H2319_qc and chain A and resi 2)
...
select qc_hotspot_17, (casp17_H2319_qc and chain C and resi 100)
...
select qc_hotspot_18, (casp17_H2319_qc and chain C and resi 102)
...
select qc_hotspot_19, (casp17_H2319_qc and chain C and resi 99)
...
select qc_hotspot_20, (casp17_H2319_qc and chain A and resi 4)
...
select qc_hotspot_21, (casp17_H2319_qc and chain A and resi 26)
...
select qc_hotspot_22, (casp17_H2319_qc and chain A and resi 5)
...
select qc_hotspot_23, (casp17_H2319_qc and chain A and resi 25)
...
select qc_hotspot_24, (casp17_H2319_qc and chain A and resi 29)
...
select qc_hotspot_25, (casp17_H2319_qc and chain B and resi 107)
...
select qc_hotspot_26, (casp17_H2319_qc and chain B and resi 109)
...
select qc_hotspot_27, (casp17_H2319_qc and chain A and resi 251)
...
select qc_hotspot_28, (casp17_H2319_qc and chain A and resi 7)
...
select qc_hotspot_29, (casp17_H2319_qc and chain A and resi 243)
...
select qc_hotspot_30, (casp17_H2319_qc and chain C and resi 105)
...
select qc_hotspot_31, (casp17_H2319_qc and chain A and resi 28)
...
select qc_hotspot_32, (casp17_H2319_qc and chain C and resi 106)
...
select qc_hotspot_33, (casp17_H2319_qc and chain B and resi 100)
...
select qc_hotspot_34, (casp17_H2319_qc and chain C and resi 103)
...
select qc_hotspot_35, (casp17_H2319_qc and chain B and resi 116)
...
select qc_hotspot_36, (casp17_H2319_qc and chain C and resi 107)
...
set label_size, 14
orient casp17_H2319_qc
zoom casp17_H2319_qc, 1.08
rotate x, 8
rotate y, -10
ray 1800, 1200
png runs/casp17_structure_renders_model_selected_shape_guarded_current/H2319_structure_qc_pymol.png, dpi=240
quit
