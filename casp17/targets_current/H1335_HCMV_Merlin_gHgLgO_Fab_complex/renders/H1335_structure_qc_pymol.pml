...
set internal_gui, 0
viewport 1800, 1200
load "runs/casp17_predictions_statistical_rotamer_current/H1335TS.pdb", casp17_H1335_qc
...
select qc_hotspot_1, (casp17_H1335_qc and chain B and resi 688)
...
label qc_hotspot_1 and name CA, "B:688"
select qc_hotspot_2, (casp17_H1335_qc and chain A and resi 438)
...
label qc_hotspot_2 and name CA, "A:438"
select qc_hotspot_3, (casp17_H1335_qc and chain B and resi 576)
color casp17_qc_dual, qc_hotspot_3
show sticks, qc_hotspot_3
show spheres, qc_hotspot_3 and name CA
set sphere_scale, 0.48, qc_hotspot_3 and name CA
label qc_hotspot_3 and name CA, "B:576"
select qc_hotspot_4, (casp17_H1335_qc and chain A and resi 233)
...
label qc_hotspot_4 and name CA, "A:233"
select qc_hotspot_5, (casp17_H1335_qc and chain B and resi 382)
...
label qc_hotspot_5 and name CA, "B:382"
select qc_hotspot_6, (casp17_H1335_qc and chain B and resi 568)
...
label qc_hotspot_6 and name CA, "B:568"
select qc_hotspot_7, (casp17_H1335_qc and chain D and resi 212)
...
select qc_hotspot_8, (casp17_H1335_qc and chain E and resi 212)
...
label qc_hotspot_8 and name CA, "E:212"
select qc_hotspot_9, (casp17_H1335_qc and chain E and resi 213)
...
label qc_hotspot_9 and name CA, "E:213"
select qc_hotspot_10, (casp17_H1335_qc and chain E and resi 214)
...
label qc_hotspot_10 and name CA, "E:214"
select qc_hotspot_11, (casp17_H1335_qc and chain B and resi 678)
...
select qc_hotspot_12, (casp17_H1335_qc and chain C and resi 242)
...
select qc_hotspot_13, (casp17_H1335_qc and chain E and resi 215)
...
select qc_hotspot_14, (casp17_H1335_qc and chain A and resi 422)
...
select qc_hotspot_15, (casp17_H1335_qc and chain B and resi 25)
...
select qc_hotspot_16, (casp17_H1335_qc and chain D and resi 210)
...
select qc_hotspot_17, (casp17_H1335_qc and chain A and resi 421)
...
select qc_hotspot_18, (casp17_H1335_qc and chain B and resi 23)
...
select qc_hotspot_19, (casp17_H1335_qc and chain A and resi 429)
...
select qc_hotspot_20, (casp17_H1335_qc and chain C and resi 246)
...
select qc_hotspot_21, (casp17_H1335_qc and chain E and resi 223)
...
select qc_hotspot_22, (casp17_H1335_qc and chain C and resi 241)
...
select qc_hotspot_23, (casp17_H1335_qc and chain A and resi 431)
...
select qc_hotspot_24, (casp17_H1335_qc and chain A and resi 432)
...
select qc_hotspot_25, (casp17_H1335_qc and chain B and resi 684)
...
select qc_hotspot_26, (casp17_H1335_qc and chain B and resi 685)
...
select qc_hotspot_27, (casp17_H1335_qc and chain E and resi 218)
...
select qc_hotspot_28, (casp17_H1335_qc and chain B and resi 3)
...
select qc_hotspot_29, (casp17_H1335_qc and chain A and resi 434)
...
select qc_hotspot_30, (casp17_H1335_qc and chain D and resi 208)
...
select qc_hotspot_31, (casp17_H1335_qc and chain D and resi 204)
...
select qc_hotspot_32, (casp17_H1335_qc and chain A and resi 435)
...
select qc_hotspot_33, (casp17_H1335_qc and chain A and resi 1)
...
select qc_hotspot_34, (casp17_H1335_qc and chain B and resi 679)
...
select qc_hotspot_35, (casp17_H1335_qc and chain B and resi 689)
...
select qc_hotspot_36, (casp17_H1335_qc and chain D and resi 214)
...
rotate y, -10
ray 1800, 1200
png runs/casp17_structure_renders_current/H1335_structure_qc_pymol.png, dpi=240
quit
