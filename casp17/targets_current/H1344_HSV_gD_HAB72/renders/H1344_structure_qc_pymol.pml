...
set internal_gui, 0
viewport 1800, 1200
load "runs/casp17_predictions_statistical_rotamer_current/H1344TS.pdb", casp17_H1344_qc
...
select qc_hotspot_3, (casp17_H1344_qc and chain B and resi 210)
...
label qc_hotspot_3 and name CA, "B:210"
select qc_hotspot_4, (casp17_H1344_qc and chain B and resi 212)
...
label qc_hotspot_4 and name CA, "B:212"
select qc_hotspot_5, (casp17_H1344_qc and chain B and resi 208)
...
label qc_hotspot_5 and name CA, "B:208"
select qc_hotspot_6, (casp17_H1344_qc and chain C and resi 273)
...
label qc_hotspot_6 and name CA, "C:273"
select qc_hotspot_7, (casp17_H1344_qc and chain C and resi 281)
...
label qc_hotspot_7 and name CA, "C:281"
select qc_hotspot_8, (casp17_H1344_qc and chain B and resi 211)
...
select qc_hotspot_9, (casp17_H1344_qc and chain C and resi 19)
...
label qc_hotspot_9 and name CA, "C:19"
select qc_hotspot_10, (casp17_H1344_qc and chain C and resi 7)
...
label qc_hotspot_10 and name CA, "C:7"
select qc_hotspot_11, (casp17_H1344_qc and chain C and resi 280)
...
select qc_hotspot_12, (casp17_H1344_qc and chain B and resi 216)
...
select qc_hotspot_13, (casp17_H1344_qc and chain C and resi 275)
...
select qc_hotspot_14, (casp17_H1344_qc and chain C and resi 23)
...
select qc_hotspot_15, (casp17_H1344_qc and chain C and resi 279)
...
select qc_hotspot_16, (casp17_H1344_qc and chain B and resi 207)
...
select qc_hotspot_17, (casp17_H1344_qc and chain C and resi 14)
...
select qc_hotspot_18, (casp17_H1344_qc and chain B and resi 8)
...
select qc_hotspot_19, (casp17_H1344_qc and chain B and resi 213)
...
select qc_hotspot_20, (casp17_H1344_qc and chain B and resi 2)
...
select qc_hotspot_21, (casp17_H1344_qc and chain B and resi 5)
...
select qc_hotspot_22, (casp17_H1344_qc and chain C and resi 2)
...
select qc_hotspot_23, (casp17_H1344_qc and chain B and resi 205)
...
select qc_hotspot_24, (casp17_H1344_qc and chain B and resi 209)
...
select qc_hotspot_25, (casp17_H1344_qc and chain C and resi 278)
...
select qc_hotspot_26, (casp17_H1344_qc and chain B and resi 9)
...
select qc_hotspot_27, (casp17_H1344_qc and chain A and resi 214)
...
select qc_hotspot_28, (casp17_H1344_qc and chain B and resi 215)
...
select qc_hotspot_29, (casp17_H1344_qc and chain B and resi 202)
...
select qc_hotspot_30, (casp17_H1344_qc and chain C and resi 6)
...
select qc_hotspot_31, (casp17_H1344_qc and chain C and resi 277)
...
select qc_hotspot_32, (casp17_H1344_qc and chain B and resi 3)
...
select qc_hotspot_33, (casp17_H1344_qc and chain C and resi 1)
...
select qc_hotspot_34, (casp17_H1344_qc and chain B and resi 1)
...
select qc_hotspot_35, (casp17_H1344_qc and chain C and resi 31)
...
select qc_hotspot_36, (casp17_H1344_qc and chain C and resi 270)
...
rotate y, -10
ray 1800, 1200
png runs/casp17_structure_renders_current/H1344_structure_qc_pymol.png, dpi=240
quit
