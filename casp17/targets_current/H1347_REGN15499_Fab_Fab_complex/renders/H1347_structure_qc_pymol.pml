...
set internal_gui, 0
viewport 1800, 1200
load "runs/casp17_predictions_model_selected_shape_guarded_coordinate_normalized_current/H1347TS.pdb", casp17_H1347_qc
hide everything, casp17_H1347_qc
remove casp17_H1347_qc and elem H
bg_color 0x08111f
...
show cartoon, casp17_H1347_qc
show sticks, casp17_H1347_qc and not name N+C+O+CA
show spheres, casp17_H1347_qc and name CA
set cartoon_transparency, 0.22, casp17_H1347_qc
set stick_transparency, 0.18, casp17_H1347_qc and not name N+C+O+CA
...
color casp17_qc_base, casp17_H1347_qc
set_color casp17_qc_chain_0, [0.3294, 0.4941, 0.8392]
color casp17_qc_chain_0, casp17_H1347_qc and chain A
set_color casp17_qc_chain_1, [0.7451, 0.3529, 0.3882]
color casp17_qc_chain_1, casp17_H1347_qc and chain B
set_color casp17_qc_chain_2, [0.2549, 0.6078, 0.5412]
color casp17_qc_chain_2, casp17_H1347_qc and chain C
set_color casp17_qc_chain_3, [0.7373, 0.5373, 0.3176]
color casp17_qc_chain_3, casp17_H1347_qc and chain D
select qc_hotspot_1, (casp17_H1347_qc and chain A and resi 45)
...
label qc_hotspot_1 and name CA, "A:45"
select qc_hotspot_2, (casp17_H1347_qc and chain A and resi 103)
...
label qc_hotspot_2 and name CA, "A:103"
select qc_hotspot_3, (casp17_H1347_qc and chain A and resi 104)
...
label qc_hotspot_3 and name CA, "A:104"
select qc_hotspot_4, (casp17_H1347_qc and chain A and resi 127)
...
label qc_hotspot_4 and name CA, "A:127"
select qc_hotspot_5, (casp17_H1347_qc and chain A and resi 150)
...
label qc_hotspot_5 and name CA, "A:150"
select qc_hotspot_6, (casp17_H1347_qc and chain A and resi 172)
...
label qc_hotspot_6 and name CA, "A:172"
select qc_hotspot_7, (casp17_H1347_qc and chain A and resi 173)
...
label qc_hotspot_7 and name CA, "A:173"
select qc_hotspot_8, (casp17_H1347_qc and chain A and resi 174)
...
label qc_hotspot_8 and name CA, "A:174"
select qc_hotspot_9, (casp17_H1347_qc and chain D and resi 70)
...
label qc_hotspot_9 and name CA, "D:70"
select qc_hotspot_10, (casp17_H1347_qc and chain D and resi 92)
...
label qc_hotspot_10 and name CA, "D:92"
select qc_hotspot_11, (casp17_H1347_qc and chain B and resi 212)
...
select qc_hotspot_12, (casp17_H1347_qc and chain D and resi 210)
...
select qc_hotspot_13, (casp17_H1347_qc and chain A and resi 215)
...
select qc_hotspot_14, (casp17_H1347_qc and chain B and resi 210)
...
select qc_hotspot_15, (casp17_H1347_qc and chain A and resi 217)
...
select qc_hotspot_16, (casp17_H1347_qc and chain A and resi 218)
...
select qc_hotspot_17, (casp17_H1347_qc and chain A and resi 222)
...
select qc_hotspot_18, (casp17_H1347_qc and chain B and resi 208)
...
select qc_hotspot_19, (casp17_H1347_qc and chain D and resi 214)
...
select qc_hotspot_20, (casp17_H1347_qc and chain B and resi 214)
...
select qc_hotspot_21, (casp17_H1347_qc and chain B and resi 204)
...
select qc_hotspot_22, (casp17_H1347_qc and chain D and resi 211)
...
select qc_hotspot_23, (casp17_H1347_qc and chain B and resi 209)
...
select qc_hotspot_24, (casp17_H1347_qc and chain C and resi 210)
...
select qc_hotspot_25, (casp17_H1347_qc and chain A and resi 210)
...
select qc_hotspot_26, (casp17_H1347_qc and chain B and resi 213)
...
select qc_hotspot_27, (casp17_H1347_qc and chain D and resi 213)
...
select qc_hotspot_28, (casp17_H1347_qc and chain B and resi 211)
...
select qc_hotspot_29, (casp17_H1347_qc and chain D and resi 1)
...
select qc_hotspot_30, (casp17_H1347_qc and chain A and resi 219)
...
select qc_hotspot_31, (casp17_H1347_qc and chain D and resi 207)
...
select qc_hotspot_32, (casp17_H1347_qc and chain A and resi 203)
...
select qc_hotspot_33, (casp17_H1347_qc and chain C and resi 26)
...
select qc_hotspot_34, (casp17_H1347_qc and chain A and resi 207)
...
select qc_hotspot_35, (casp17_H1347_qc and chain C and resi 27)
...
select qc_hotspot_36, (casp17_H1347_qc and chain A and resi 206)
...
set label_size, 14
orient casp17_H1347_qc
zoom casp17_H1347_qc, 1.08
rotate x, 8
rotate y, -10
ray 1800, 1200
png runs/casp17_structure_renders_model_selected_shape_guarded_current/H1347_structure_qc_pymol.png, dpi=240
quit
