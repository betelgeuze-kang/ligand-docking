...
set internal_gui, 0
viewport 1800, 1200
load "runs/casp17_predictions_statistical_rotamer_current/H1347TS.pdb", casp17_H1347_qc
...
select qc_hotspot_1, (casp17_H1347_qc and chain D and resi 210)
...
label qc_hotspot_1 and name CA, "D:210"
select qc_hotspot_2, (casp17_H1347_qc and chain D and resi 214)
...
label qc_hotspot_2 and name CA, "D:214"
select qc_hotspot_3, (casp17_H1347_qc and chain B and resi 212)
...
select qc_hotspot_4, (casp17_H1347_qc and chain D and resi 211)
...
label qc_hotspot_4 and name CA, "D:211"
select qc_hotspot_5, (casp17_H1347_qc and chain D and resi 1)
...
label qc_hotspot_5 and name CA, "D:1"
select qc_hotspot_6, (casp17_H1347_qc and chain D and resi 213)
...
label qc_hotspot_6 and name CA, "D:213"
select qc_hotspot_7, (casp17_H1347_qc and chain D and resi 212)
...
label qc_hotspot_7 and name CA, "D:212"
select qc_hotspot_8, (casp17_H1347_qc and chain B and resi 214)
...
label qc_hotspot_8 and name CA, "B:214"
select qc_hotspot_9, (casp17_H1347_qc and chain A and resi 215)
...
label qc_hotspot_9 and name CA, "A:215"
select qc_hotspot_10, (casp17_H1347_qc and chain B and resi 210)
...
select qc_hotspot_11, (casp17_H1347_qc and chain D and resi 2)
...
select qc_hotspot_12, (casp17_H1347_qc and chain D and resi 207)
...
select qc_hotspot_13, (casp17_H1347_qc and chain A and resi 217)
...
select qc_hotspot_14, (casp17_H1347_qc and chain B and resi 208)
...
select qc_hotspot_15, (casp17_H1347_qc and chain B and resi 204)
...
select qc_hotspot_18, (casp17_H1347_qc and chain D and resi 208)
...
select qc_hotspot_19, (casp17_H1347_qc and chain B and resi 213)
...
select qc_hotspot_20, (casp17_H1347_qc and chain D and resi 8)
...
select qc_hotspot_21, (casp17_H1347_qc and chain A and resi 210)
...
select qc_hotspot_22, (casp17_H1347_qc and chain D and resi 7)
...
select qc_hotspot_24, (casp17_H1347_qc and chain D and resi 209)
...
select qc_hotspot_25, (casp17_H1347_qc and chain C and resi 8)
...
select qc_hotspot_26, (casp17_H1347_qc and chain D and resi 3)
...
select qc_hotspot_27, (casp17_H1347_qc and chain B and resi 1)
...
select qc_hotspot_29, (casp17_H1347_qc and chain A and resi 207)
...
select qc_hotspot_30, (casp17_H1347_qc and chain C and resi 9)
...
select qc_hotspot_31, (casp17_H1347_qc and chain D and resi 5)
...
select qc_hotspot_32, (casp17_H1347_qc and chain C and resi 10)
...
select qc_hotspot_33, (casp17_H1347_qc and chain B and resi 206)
...
select qc_hotspot_34, (casp17_H1347_qc and chain A and resi 206)
...
select qc_hotspot_35, (casp17_H1347_qc and chain A and resi 219)
...
select qc_hotspot_36, (casp17_H1347_qc and chain C and resi 14)
...
rotate y, -10
ray 1800, 1200
png runs/casp17_structure_renders_current/H1347_structure_qc_pymol.png, dpi=240
quit
