...
set internal_gui, 0
viewport 1800, 1200
load "runs/casp17_predictions_model_selected_shape_guarded_coordinate_normalized_current/H1349TS.pdb", casp17_H1349_qc
hide everything, casp17_H1349_qc
remove casp17_H1349_qc and elem H
bg_color 0x08111f
...
show cartoon, casp17_H1349_qc
show sticks, casp17_H1349_qc and not name N+C+O+CA
show spheres, casp17_H1349_qc and name CA
set cartoon_transparency, 0.22, casp17_H1349_qc
set stick_transparency, 0.18, casp17_H1349_qc and not name N+C+O+CA
...
color casp17_qc_base, casp17_H1349_qc
set_color casp17_qc_chain_0, [0.3294, 0.4941, 0.8392]
color casp17_qc_chain_0, casp17_H1349_qc and chain A
set_color casp17_qc_chain_1, [0.7451, 0.3529, 0.3882]
color casp17_qc_chain_1, casp17_H1349_qc and chain B
set_color casp17_qc_chain_2, [0.2549, 0.6078, 0.5412]
color casp17_qc_chain_2, casp17_H1349_qc and chain C
select qc_hotspot_1, (casp17_H1349_qc and chain B and resi 217)
...
label qc_hotspot_1 and name CA, "B:217"
select qc_hotspot_2, (casp17_H1349_qc and chain C and resi 212)
...
label qc_hotspot_2 and name CA, "C:212"
select qc_hotspot_3, (casp17_H1349_qc and chain C and resi 1)
...
label qc_hotspot_3 and name CA, "C:1"
select qc_hotspot_4, (casp17_H1349_qc and chain B and resi 209)
...
label qc_hotspot_4 and name CA, "B:209"
select qc_hotspot_5, (casp17_H1349_qc and chain B and resi 212)
...
label qc_hotspot_5 and name CA, "B:212"
select qc_hotspot_6, (casp17_H1349_qc and chain B and resi 219)
...
label qc_hotspot_6 and name CA, "B:219"
select qc_hotspot_7, (casp17_H1349_qc and chain A and resi 577)
...
label qc_hotspot_7 and name CA, "A:577"
select qc_hotspot_8, (casp17_H1349_qc and chain B and resi 208)
...
label qc_hotspot_8 and name CA, "B:208"
select qc_hotspot_9, (casp17_H1349_qc and chain C and resi 210)
...
label qc_hotspot_9 and name CA, "C:210"
select qc_hotspot_10, (casp17_H1349_qc and chain A and resi 578)
...
label qc_hotspot_10 and name CA, "A:578"
select qc_hotspot_11, (casp17_H1349_qc and chain B and resi 205)
...
select qc_hotspot_12, (casp17_H1349_qc and chain C and resi 208)
...
select qc_hotspot_13, (casp17_H1349_qc and chain C and resi 214)
...
select qc_hotspot_14, (casp17_H1349_qc and chain B and resi 216)
...
select qc_hotspot_15, (casp17_H1349_qc and chain B and resi 207)
...
select qc_hotspot_16, (casp17_H1349_qc and chain B and resi 211)
...
select qc_hotspot_17, (casp17_H1349_qc and chain A and resi 581)
...
select qc_hotspot_18, (casp17_H1349_qc and chain A and resi 582)
...
select qc_hotspot_19, (casp17_H1349_qc and chain B and resi 214)
...
select qc_hotspot_20, (casp17_H1349_qc and chain A and resi 575)
...
select qc_hotspot_21, (casp17_H1349_qc and chain A and resi 574)
...
select qc_hotspot_22, (casp17_H1349_qc and chain B and resi 215)
...
select qc_hotspot_23, (casp17_H1349_qc and chain C and resi 209)
...
select qc_hotspot_24, (casp17_H1349_qc and chain C and resi 204)
...
select qc_hotspot_25, (casp17_H1349_qc and chain A and resi 594)
...
select qc_hotspot_26, (casp17_H1349_qc and chain C and resi 213)
...
select qc_hotspot_27, (casp17_H1349_qc and chain B and resi 213)
...
select qc_hotspot_28, (casp17_H1349_qc and chain C and resi 211)
...
select qc_hotspot_29, (casp17_H1349_qc and chain C and resi 8)
...
select qc_hotspot_30, (casp17_H1349_qc and chain C and resi 5)
...
select qc_hotspot_31, (casp17_H1349_qc and chain B and resi 210)
...
select qc_hotspot_32, (casp17_H1349_qc and chain A and resi 5)
...
select qc_hotspot_33, (casp17_H1349_qc and chain C and resi 16)
...
select qc_hotspot_34, (casp17_H1349_qc and chain B and resi 218)
...
select qc_hotspot_35, (casp17_H1349_qc and chain C and resi 15)
...
select qc_hotspot_36, (casp17_H1349_qc and chain A and resi 541)
...
set label_size, 14
orient casp17_H1349_qc
zoom casp17_H1349_qc, 1.08
rotate x, 8
rotate y, -10
ray 1800, 1200
png runs/casp17_structure_renders_model_selected_shape_guarded_current/H1349_structure_qc_pymol.png, dpi=240
quit
