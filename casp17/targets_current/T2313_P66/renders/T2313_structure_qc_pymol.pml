...
set internal_gui, 0
viewport 1800, 1200
load "runs/casp17_predictions_model_selected_shape_guarded_coordinate_normalized_current/T2313TS.pdb", casp17_T2313_qc
hide everything, casp17_T2313_qc
remove casp17_T2313_qc and elem H
bg_color 0x08111f
...
show cartoon, casp17_T2313_qc
show sticks, casp17_T2313_qc and not name N+C+O+CA
show spheres, casp17_T2313_qc and name CA
set cartoon_transparency, 0.22, casp17_T2313_qc
set stick_transparency, 0.18, casp17_T2313_qc and not name N+C+O+CA
...
color casp17_qc_base, casp17_T2313_qc
set_color casp17_qc_chain_0, [0.3294, 0.4941, 0.8392]
color casp17_qc_chain_0, casp17_T2313_qc and chain A
select qc_hotspot_1, (casp17_T2313_qc and chain A and resi 605)
...
label qc_hotspot_1 and name CA, "A:605"
select qc_hotspot_2, (casp17_T2313_qc and chain A and resi 617)
...
label qc_hotspot_2 and name CA, "A:617"
select qc_hotspot_3, (casp17_T2313_qc and chain A and resi 606)
...
label qc_hotspot_3 and name CA, "A:606"
select qc_hotspot_4, (casp17_T2313_qc and chain A and resi 616)
...
label qc_hotspot_4 and name CA, "A:616"
select qc_hotspot_5, (casp17_T2313_qc and chain A and resi 570)
...
label qc_hotspot_5 and name CA, "A:570"
select qc_hotspot_6, (casp17_T2313_qc and chain A and resi 29)
...
label qc_hotspot_6 and name CA, "A:29"
select qc_hotspot_7, (casp17_T2313_qc and chain A and resi 35)
...
label qc_hotspot_7 and name CA, "A:35"
select qc_hotspot_8, (casp17_T2313_qc and chain A and resi 611)
...
label qc_hotspot_8 and name CA, "A:611"
select qc_hotspot_9, (casp17_T2313_qc and chain A and resi 608)
...
label qc_hotspot_9 and name CA, "A:608"
select qc_hotspot_10, (casp17_T2313_qc and chain A and resi 618)
...
label qc_hotspot_10 and name CA, "A:618"
select qc_hotspot_11, (casp17_T2313_qc and chain A and resi 23)
...
select qc_hotspot_12, (casp17_T2313_qc and chain A and resi 615)
...
select qc_hotspot_13, (casp17_T2313_qc and chain A and resi 3)
...
select qc_hotspot_14, (casp17_T2313_qc and chain A and resi 601)
...
select qc_hotspot_15, (casp17_T2313_qc and chain A and resi 610)
...
select qc_hotspot_16, (casp17_T2313_qc and chain A and resi 58)
...
select qc_hotspot_17, (casp17_T2313_qc and chain A and resi 609)
...
select qc_hotspot_18, (casp17_T2313_qc and chain A and resi 612)
...
select qc_hotspot_19, (casp17_T2313_qc and chain A and resi 572)
...
select qc_hotspot_20, (casp17_T2313_qc and chain A and resi 38)
...
select qc_hotspot_21, (casp17_T2313_qc and chain A and resi 600)
...
select qc_hotspot_22, (casp17_T2313_qc and chain A and resi 34)
...
select qc_hotspot_23, (casp17_T2313_qc and chain A and resi 585)
...
select qc_hotspot_24, (casp17_T2313_qc and chain A and resi 607)
...
select qc_hotspot_25, (casp17_T2313_qc and chain A and resi 57)
...
select qc_hotspot_26, (casp17_T2313_qc and chain A and resi 613)
...
select qc_hotspot_27, (casp17_T2313_qc and chain A and resi 31)
...
select qc_hotspot_28, (casp17_T2313_qc and chain A and resi 614)
...
select qc_hotspot_29, (casp17_T2313_qc and chain A and resi 599)
...
select qc_hotspot_30, (casp17_T2313_qc and chain A and resi 580)
...
select qc_hotspot_31, (casp17_T2313_qc and chain A and resi 71)
...
select qc_hotspot_32, (casp17_T2313_qc and chain A and resi 569)
...
select qc_hotspot_33, (casp17_T2313_qc and chain A and resi 63)
...
select qc_hotspot_34, (casp17_T2313_qc and chain A and resi 581)
...
select qc_hotspot_35, (casp17_T2313_qc and chain A and resi 598)
...
select qc_hotspot_36, (casp17_T2313_qc and chain A and resi 66)
...
set label_size, 14
orient casp17_T2313_qc
zoom casp17_T2313_qc, 1.08
rotate x, 8
rotate y, -10
ray 1800, 1200
png runs/casp17_structure_renders_model_selected_shape_guarded_current/T2313_structure_qc_pymol.png, dpi=240
quit
