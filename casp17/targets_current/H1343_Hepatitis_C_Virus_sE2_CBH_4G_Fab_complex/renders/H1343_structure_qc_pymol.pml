...
set internal_gui, 0
viewport 1800, 1200
load "runs/casp17_predictions_statistical_rotamer_current/H1343TS.pdb", casp17_H1343_qc
...
select qc_hotspot_1, (casp17_H1343_qc and chain A and resi 39)
...
label qc_hotspot_1 and name CA, "A:39"
select qc_hotspot_2, (casp17_H1343_qc and chain A and resi 44)
...
label qc_hotspot_2 and name CA, "A:44"
select qc_hotspot_3, (casp17_H1343_qc and chain C and resi 159)
...
label qc_hotspot_3 and name CA, "C:159"
select qc_hotspot_4, (casp17_H1343_qc and chain C and resi 270)
...
label qc_hotspot_4 and name CA, "C:270"
...
select qc_hotspot_7, (casp17_H1343_qc and chain B and resi 210)
...
label qc_hotspot_7 and name CA, "B:210"
...
select qc_hotspot_9, (casp17_H1343_qc and chain C and resi 314)
...
label qc_hotspot_9 and name CA, "C:314"
select qc_hotspot_10, (casp17_H1343_qc and chain B and resi 214)
...
label qc_hotspot_10 and name CA, "B:214"
select qc_hotspot_11, (casp17_H1343_qc and chain B and resi 208)
...
select qc_hotspot_12, (casp17_H1343_qc and chain C and resi 310)
...
select qc_hotspot_13, (casp17_H1343_qc and chain C and resi 313)
...
select qc_hotspot_14, (casp17_H1343_qc and chain B and resi 204)
...
select qc_hotspot_15, (casp17_H1343_qc and chain B and resi 1)
...
select qc_hotspot_16, (casp17_H1343_qc and chain C and resi 25)
...
select qc_hotspot_17, (casp17_H1343_qc and chain C and resi 309)
...
select qc_hotspot_18, (casp17_H1343_qc and chain B and resi 206)
...
select qc_hotspot_19, (casp17_H1343_qc and chain B and resi 209)
...
select qc_hotspot_20, (casp17_H1343_qc and chain C and resi 317)
...
select qc_hotspot_21, (casp17_H1343_qc and chain B and resi 213)
...
select qc_hotspot_22, (casp17_H1343_qc and chain C and resi 1)
...
select qc_hotspot_23, (casp17_H1343_qc and chain A and resi 241)
...
select qc_hotspot_24, (casp17_H1343_qc and chain B and resi 211)
...
select qc_hotspot_25, (casp17_H1343_qc and chain C and resi 7)
...
select qc_hotspot_26, (casp17_H1343_qc and chain A and resi 240)
...
select qc_hotspot_27, (casp17_H1343_qc and chain A and resi 237)
...
select qc_hotspot_28, (casp17_H1343_qc and chain A and resi 26)
...
select qc_hotspot_29, (casp17_H1343_qc and chain A and resi 27)
...
select qc_hotspot_30, (casp17_H1343_qc and chain A and resi 236)
...
select qc_hotspot_31, (casp17_H1343_qc and chain A and resi 239)
...
select qc_hotspot_32, (casp17_H1343_qc and chain C and resi 311)
...
select qc_hotspot_33, (casp17_H1343_qc and chain C and resi 24)
...
select qc_hotspot_34, (casp17_H1343_qc and chain C and resi 4)
...
select qc_hotspot_35, (casp17_H1343_qc and chain B and resi 205)
...
select qc_hotspot_36, (casp17_H1343_qc and chain C and resi 29)
...
rotate y, -10
ray 1800, 1200
png runs/casp17_structure_renders_current/H1343_structure_qc_pymol.png, dpi=240
quit
