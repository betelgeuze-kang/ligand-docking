...
set internal_gui, 0
viewport 1800, 1200
load "runs/casp17_predictions_model_selected_shape_guarded_coordinate_normalized_current/T1342TS.pdb", casp17_T1342_qc
...
select qc_hotspot_1, (casp17_T1342_qc and chain A and resi 28)
...
label qc_hotspot_1 and name CA, "A:28"
select qc_hotspot_2, (casp17_T1342_qc and chain A and resi 1445)
...
label qc_hotspot_2 and name CA, "A:1445"
select qc_hotspot_3, (casp17_T1342_qc and chain A and resi 1446)
...
label qc_hotspot_3 and name CA, "A:1446"
select qc_hotspot_4, (casp17_T1342_qc and chain A and resi 23)
...
label qc_hotspot_4 and name CA, "A:23"
select qc_hotspot_5, (casp17_T1342_qc and chain A and resi 65)
...
label qc_hotspot_5 and name CA, "A:65"
select qc_hotspot_6, (casp17_T1342_qc and chain A and resi 1409)
...
label qc_hotspot_6 and name CA, "A:1409"
select qc_hotspot_7, (casp17_T1342_qc and chain A and resi 60)
...
label qc_hotspot_7 and name CA, "A:60"
select qc_hotspot_8, (casp17_T1342_qc and chain A and resi 27)
...
label qc_hotspot_8 and name CA, "A:27"
select qc_hotspot_9, (casp17_T1342_qc and chain A and resi 70)
...
label qc_hotspot_9 and name CA, "A:70"
select qc_hotspot_10, (casp17_T1342_qc and chain A and resi 3)
...
label qc_hotspot_10 and name CA, "A:3"
select qc_hotspot_11, (casp17_T1342_qc and chain A and resi 102)
...
select qc_hotspot_12, (casp17_T1342_qc and chain A and resi 1447)
...
select qc_hotspot_13, (casp17_T1342_qc and chain A and resi 97)
...
select qc_hotspot_14, (casp17_T1342_qc and chain A and resi 1369)
...
select qc_hotspot_15, (casp17_T1342_qc and chain A and resi 22)
...
select qc_hotspot_16, (casp17_T1342_qc and chain A and resi 34)
...
select qc_hotspot_17, (casp17_T1342_qc and chain A and resi 1377)
...
select qc_hotspot_18, (casp17_T1342_qc and chain A and resi 63)
...
select qc_hotspot_19, (casp17_T1342_qc and chain A and resi 29)
...
select qc_hotspot_20, (casp17_T1342_qc and chain A and resi 62)
...
select qc_hotspot_22, (casp17_T1342_qc and chain A and resi 1401)
...
select qc_hotspot_23, (casp17_T1342_qc and chain A and resi 1)
...
select qc_hotspot_24, (casp17_T1342_qc and chain A and resi 61)
...
select qc_hotspot_26, (casp17_T1342_qc and chain A and resi 1408)
...
select qc_hotspot_27, (casp17_T1342_qc and chain A and resi 137)
...
select qc_hotspot_28, (casp17_T1342_qc and chain A and resi 1333)
...
select qc_hotspot_29, (casp17_T1342_qc and chain A and resi 1379)
...
select qc_hotspot_30, (casp17_T1342_qc and chain A and resi 13)
...
select qc_hotspot_31, (casp17_T1342_qc and chain A and resi 36)
...
select qc_hotspot_32, (casp17_T1342_qc and chain A and resi 59)
...
select qc_hotspot_33, (casp17_T1342_qc and chain A and resi 41)
...
select qc_hotspot_34, (casp17_T1342_qc and chain A and resi 33)
...
select qc_hotspot_35, (casp17_T1342_qc and chain A and resi 1442)
...
select qc_hotspot_36, (casp17_T1342_qc and chain A and resi 141)
...
rotate y, -10
ray 1800, 1200
png runs/casp17_structure_renders_model_selected_shape_guarded_current/T1342_structure_qc_pymol.png, dpi=240
quit
