...
set internal_gui, 0
viewport 1800, 1200
load "runs/casp17_predictions_statistical_rotamer_current/H2312TS.pdb", casp17_H2312_qc
...
select qc_hotspot_1, (casp17_H2312_qc and chain A and resi 641)
...
label qc_hotspot_1 and name CA, "A:641"
select qc_hotspot_2, (casp17_H2312_qc and chain B and resi 31)
...
label qc_hotspot_2 and name CA, "B:31"
select qc_hotspot_3, (casp17_H2312_qc and chain A and resi 176)
...
label qc_hotspot_3 and name CA, "A:176"
select qc_hotspot_4, (casp17_H2312_qc and chain B and resi 220)
...
label qc_hotspot_4 and name CA, "B:220"
select qc_hotspot_5, (casp17_H2312_qc and chain B and resi 245)
...
label qc_hotspot_5 and name CA, "B:245"
select qc_hotspot_6, (casp17_H2312_qc and chain B and resi 266)
...
label qc_hotspot_6 and name CA, "B:266"
select qc_hotspot_7, (casp17_H2312_qc and chain C and resi 118)
...
label qc_hotspot_7 and name CA, "C:118"
select qc_hotspot_8, (casp17_H2312_qc and chain A and resi 646)
...
label qc_hotspot_8 and name CA, "A:646"
select qc_hotspot_9, (casp17_H2312_qc and chain C and resi 119)
...
label qc_hotspot_9 and name CA, "C:119"
select qc_hotspot_10, (casp17_H2312_qc and chain A and resi 645)
...
label qc_hotspot_10 and name CA, "A:645"
select qc_hotspot_11, (casp17_H2312_qc and chain C and resi 122)
...
select qc_hotspot_12, (casp17_H2312_qc and chain A and resi 2)
...
select qc_hotspot_13, (casp17_H2312_qc and chain C and resi 116)
...
select qc_hotspot_14, (casp17_H2312_qc and chain B and resi 635)
...
select qc_hotspot_15, (casp17_H2312_qc and chain A and resi 33)
...
select qc_hotspot_16, (casp17_H2312_qc and chain B and resi 4)
...
select qc_hotspot_17, (casp17_H2312_qc and chain A and resi 647)
...
select qc_hotspot_18, (casp17_H2312_qc and chain A and resi 649)
...
select qc_hotspot_19, (casp17_H2312_qc and chain A and resi 640)
...
select qc_hotspot_20, (casp17_H2312_qc and chain B and resi 18)
...
select qc_hotspot_21, (casp17_H2312_qc and chain A and resi 636)
...
select qc_hotspot_22, (casp17_H2312_qc and chain B and resi 34)
...
select qc_hotspot_23, (casp17_H2312_qc and chain A and resi 615)
...
select qc_hotspot_24, (casp17_H2312_qc and chain C and resi 123)
...
select qc_hotspot_25, (casp17_H2312_qc and chain C and resi 121)
...
select qc_hotspot_26, (casp17_H2312_qc and chain B and resi 26)
...
select qc_hotspot_27, (casp17_H2312_qc and chain B and resi 29)
...
select qc_hotspot_28, (casp17_H2312_qc and chain A and resi 27)
...
select qc_hotspot_29, (casp17_H2312_qc and chain B and resi 2)
...
select qc_hotspot_30, (casp17_H2312_qc and chain B and resi 611)
...
select qc_hotspot_31, (casp17_H2312_qc and chain A and resi 604)
...
select qc_hotspot_32, (casp17_H2312_qc and chain A and resi 25)
...
select qc_hotspot_33, (casp17_H2312_qc and chain A and resi 1)
...
select qc_hotspot_34, (casp17_H2312_qc and chain B and resi 15)
...
select qc_hotspot_35, (casp17_H2312_qc and chain C and resi 120)
...
select qc_hotspot_36, (casp17_H2312_qc and chain B and resi 615)
...
rotate y, -10
ray 1800, 1200
png runs/casp17_structure_renders_current/H2312_structure_qc_pymol.png, dpi=240
quit
