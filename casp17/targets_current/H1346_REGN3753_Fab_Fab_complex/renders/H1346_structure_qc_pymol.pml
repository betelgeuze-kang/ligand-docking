...
set internal_gui, 0
viewport 1800, 1200
load "runs/casp17_predictions_statistical_rotamer_current/H1346TS.pdb", casp17_H1346_qc
...
select qc_hotspot_1, (casp17_H1346_qc and chain B and resi 20)
...
label qc_hotspot_1 and name CA, "B:20"
select qc_hotspot_2, (casp17_H1346_qc and chain B and resi 50)
...
label qc_hotspot_2 and name CA, "B:50"
select qc_hotspot_3, (casp17_H1346_qc and chain B and resi 212)
...
select qc_hotspot_4, (casp17_H1346_qc and chain D and resi 213)
...
label qc_hotspot_4 and name CA, "D:213"
select qc_hotspot_5, (casp17_H1346_qc and chain C and resi 230)
...
label qc_hotspot_5 and name CA, "C:230"
select qc_hotspot_6, (casp17_H1346_qc and chain C and resi 229)
...
label qc_hotspot_6 and name CA, "C:229"
select qc_hotspot_7, (casp17_H1346_qc and chain C and resi 228)
...
label qc_hotspot_7 and name CA, "C:228"
select qc_hotspot_8, (casp17_H1346_qc and chain D and resi 211)
...
label qc_hotspot_8 and name CA, "D:211"
select qc_hotspot_9, (casp17_H1346_qc and chain B and resi 214)
...
label qc_hotspot_9 and name CA, "B:214"
...
select qc_hotspot_11, (casp17_H1346_qc and chain C and resi 214)
...
select qc_hotspot_12, (casp17_H1346_qc and chain D and resi 1)
...
select qc_hotspot_13, (casp17_H1346_qc and chain D and resi 209)
...
select qc_hotspot_14, (casp17_H1346_qc and chain B and resi 208)
...
select qc_hotspot_15, (casp17_H1346_qc and chain B and resi 204)
...
select qc_hotspot_16, (casp17_H1346_qc and chain B and resi 213)
...
select qc_hotspot_17, (casp17_H1346_qc and chain D and resi 205)
...
select qc_hotspot_18, (casp17_H1346_qc and chain D and resi 215)
...
select qc_hotspot_19, (casp17_H1346_qc and chain B and resi 209)
...
select qc_hotspot_20, (casp17_H1346_qc and chain D and resi 210)
...
select qc_hotspot_21, (casp17_H1346_qc and chain B and resi 1)
...
select qc_hotspot_22, (casp17_H1346_qc and chain B and resi 211)
...
select qc_hotspot_23, (casp17_H1346_qc and chain D and resi 207)
...
select qc_hotspot_24, (casp17_H1346_qc and chain C and resi 225)
...
select qc_hotspot_25, (casp17_H1346_qc and chain C and resi 216)
...
select qc_hotspot_26, (casp17_H1346_qc and chain D and resi 212)
...
select qc_hotspot_27, (casp17_H1346_qc and chain C and resi 215)
...
select qc_hotspot_28, (casp17_H1346_qc and chain C and resi 220)
...
select qc_hotspot_29, (casp17_H1346_qc and chain D and resi 214)
...
select qc_hotspot_30, (casp17_H1346_qc and chain A and resi 220)
...
select qc_hotspot_31, (casp17_H1346_qc and chain C and resi 217)
...
select qc_hotspot_32, (casp17_H1346_qc and chain D and resi 8)
...
select qc_hotspot_33, (casp17_H1346_qc and chain B and resi 206)
...
select qc_hotspot_34, (casp17_H1346_qc and chain C and resi 211)
...
select qc_hotspot_35, (casp17_H1346_qc and chain A and resi 212)
...
select qc_hotspot_36, (casp17_H1346_qc and chain A and resi 208)
...
rotate y, -10
ray 1800, 1200
png runs/casp17_structure_renders_current/H1346_structure_qc_pymol.png, dpi=240
quit
