...
set internal_gui, 0
viewport 1800, 1200
load "runs/casp17_predictions_statistical_rotamer_current/H2321TS.pdb", casp17_H2321_qc
...
select qc_hotspot_1, (casp17_H2321_qc and chain C and resi 101)
...
select qc_hotspot_2, (casp17_H2321_qc and chain B and resi 121)
...
label qc_hotspot_2 and name CA, "B:121"
select qc_hotspot_3, (casp17_H2321_qc and chain C and resi 102)
...
select qc_hotspot_4, (casp17_H2321_qc and chain C and resi 100)
...
label qc_hotspot_4 and name CA, "C:100"
select qc_hotspot_5, (casp17_H2321_qc and chain B and resi 120)
...
label qc_hotspot_5 and name CA, "B:120"
select qc_hotspot_6, (casp17_H2321_qc and chain C and resi 99)
...
label qc_hotspot_6 and name CA, "C:99"
select qc_hotspot_7, (casp17_H2321_qc and chain B and resi 1)
...
select qc_hotspot_8, (casp17_H2321_qc and chain A and resi 1)
...
label qc_hotspot_8 and name CA, "A:1"
select qc_hotspot_9, (casp17_H2321_qc and chain A and resi 2)
...
label qc_hotspot_9 and name CA, "A:2"
select qc_hotspot_10, (casp17_H2321_qc and chain A and resi 29)
...
label qc_hotspot_10 and name CA, "A:29"
select qc_hotspot_11, (casp17_H2321_qc and chain C and resi 103)
...
select qc_hotspot_12, (casp17_H2321_qc and chain A and resi 26)
...
select qc_hotspot_13, (casp17_H2321_qc and chain A and resi 4)
...
select qc_hotspot_14, (casp17_H2321_qc and chain A and resi 25)
...
select qc_hotspot_15, (casp17_H2321_qc and chain C and resi 104)
...
select qc_hotspot_16, (casp17_H2321_qc and chain C and resi 108)
...
select qc_hotspot_17, (casp17_H2321_qc and chain A and resi 5)
...
select qc_hotspot_18, (casp17_H2321_qc and chain B and resi 119)
...
select qc_hotspot_19, (casp17_H2321_qc and chain C and resi 107)
...
select qc_hotspot_20, (casp17_H2321_qc and chain A and resi 28)
...
select qc_hotspot_21, (casp17_H2321_qc and chain B and resi 118)
...
select qc_hotspot_22, (casp17_H2321_qc and chain A and resi 7)
...
select qc_hotspot_23, (casp17_H2321_qc and chain C and resi 105)
...
select qc_hotspot_24, (casp17_H2321_qc and chain B and resi 2)
...
select qc_hotspot_25, (casp17_H2321_qc and chain B and resi 114)
...
select qc_hotspot_26, (casp17_H2321_qc and chain C and resi 106)
...
select qc_hotspot_27, (casp17_H2321_qc and chain A and resi 251)
...
select qc_hotspot_28, (casp17_H2321_qc and chain A and resi 9)
...
select qc_hotspot_29, (casp17_H2321_qc and chain B and resi 8)
...
select qc_hotspot_30, (casp17_H2321_qc and chain C and resi 1)
...
select qc_hotspot_31, (casp17_H2321_qc and chain A and resi 6)
...
select qc_hotspot_33, (casp17_H2321_qc and chain B and resi 116)
...
select qc_hotspot_34, (casp17_H2321_qc and chain A and resi 11)
...
select qc_hotspot_35, (casp17_H2321_qc and chain B and resi 115)
...
select qc_hotspot_36, (casp17_H2321_qc and chain A and resi 33)
...
rotate y, -10
ray 1800, 1200
png runs/casp17_structure_renders_current/H2321_structure_qc_pymol.png, dpi=240
quit
