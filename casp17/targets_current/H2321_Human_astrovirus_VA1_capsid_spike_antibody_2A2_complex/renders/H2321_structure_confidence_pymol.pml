...
set internal_gui, 0
viewport 1800, 1200
load "runs/casp17_predictions_model_selected_shape_guarded_coordinate_normalized_current/H2321TS.pdb", casp17_H2321_confidence
...
color casp17_conf_very_low, casp17_H2321_confidence and b >= 45.949 and b < 59.968
set_color casp17_conf_low, [0.851, 0.4667, 0.0235]
color casp17_conf_low, casp17_H2321_confidence and b >= 59.968 and b < 67.978
set_color casp17_conf_medium, [0.0196, 0.5882, 0.4118]
color casp17_conf_medium, casp17_H2321_confidence and b >= 67.978 and b < 77.189
set_color casp17_conf_high, [0.1451, 0.3882, 0.9216]
color casp17_conf_high, casp17_H2321_confidence and b >= 77.189 and b < 86.001
...
rotate y, -12
ray 1800, 1200
png runs/casp17_structure_renders_model_selected_shape_guarded_current/H2321_structure_confidence_pymol.png, dpi=240
quit
