...
set internal_gui, 0
viewport 1800, 1200
load "runs/casp17_predictions_statistical_rotamer_current/H2339TS.pdb", casp17_H2339_qc
...
select qc_hotspot_1, (casp17_H2339_qc and chain C and resi 169)
...
select qc_hotspot_2, (casp17_H2339_qc and chain C and resi 313)
...
select qc_hotspot_4, (casp17_H2339_qc and chain D and resi 3)
...
label qc_hotspot_4 and name CA, "D:3"
select qc_hotspot_5, (casp17_H2339_qc and chain D and resi 4)
...
label qc_hotspot_5 and name CA, "D:4"
select qc_hotspot_6, (casp17_H2339_qc and chain B and resi 210)
...
label qc_hotspot_6 and name CA, "B:210"
select qc_hotspot_7, (casp17_H2339_qc and chain A and resi 207)
...
label qc_hotspot_7 and name CA, "A:207"
select qc_hotspot_8, (casp17_H2339_qc and chain A and resi 213)
...
label qc_hotspot_8 and name CA, "A:213"
select qc_hotspot_9, (casp17_H2339_qc and chain A and resi 210)
...
label qc_hotspot_9 and name CA, "A:210"
select qc_hotspot_10, (casp17_H2339_qc and chain A and resi 209)
...
label qc_hotspot_10 and name CA, "A:209"
select qc_hotspot_11, (casp17_H2339_qc and chain B and resi 214)
...
select qc_hotspot_12, (casp17_H2339_qc and chain B and resi 208)
...
select qc_hotspot_13, (casp17_H2339_qc and chain B and resi 1)
...
select qc_hotspot_14, (casp17_H2339_qc and chain A and resi 208)
...
select qc_hotspot_15, (casp17_H2339_qc and chain D and resi 238)
...
select qc_hotspot_16, (casp17_H2339_qc and chain D and resi 2)
...
select qc_hotspot_17, (casp17_H2339_qc and chain D and resi 5)
...
select qc_hotspot_18, (casp17_H2339_qc and chain C and resi 350)
...
select qc_hotspot_19, (casp17_H2339_qc and chain B and resi 213)
...
select qc_hotspot_20, (casp17_H2339_qc and chain A and resi 221)
...
select qc_hotspot_21, (casp17_H2339_qc and chain C and resi 368)
...
select qc_hotspot_22, (casp17_H2339_qc and chain B and resi 209)
...
select qc_hotspot_23, (casp17_H2339_qc and chain A and resi 218)
...
select qc_hotspot_24, (casp17_H2339_qc and chain B and resi 211)
...
select qc_hotspot_25, (casp17_H2339_qc and chain A and resi 212)
...
select qc_hotspot_26, (casp17_H2339_qc and chain C and resi 23)
...
select qc_hotspot_27, (casp17_H2339_qc and chain D and resi 235)
...
select qc_hotspot_28, (casp17_H2339_qc and chain C and resi 360)
...
select qc_hotspot_29, (casp17_H2339_qc and chain B and resi 204)
...
select qc_hotspot_30, (casp17_H2339_qc and chain C and resi 359)
...
select qc_hotspot_31, (casp17_H2339_qc and chain C and resi 363)
...
select qc_hotspot_32, (casp17_H2339_qc and chain D and resi 1)
...
select qc_hotspot_33, (casp17_H2339_qc and chain A and resi 222)
...
select qc_hotspot_34, (casp17_H2339_qc and chain C and resi 364)
...
select qc_hotspot_35, (casp17_H2339_qc and chain B and resi 206)
...
select qc_hotspot_36, (casp17_H2339_qc and chain A and resi 223)
...
rotate y, -10
ray 1800, 1200
png runs/casp17_structure_renders_current/H2339_structure_qc_pymol.png, dpi=240
quit
