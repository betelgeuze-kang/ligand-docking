# HIST_WW_DOMAIN_FIP35 No-Leak Provenance Request

CLEARANCE_EVIDENCE_STATUS: request_template

This file is an operator request template, not completed no-leak evidence.
- target_id: `HIST_WW_DOMAIN_FIP35`
- scope: `monomer`
- prediction_pdb: `data/internal_structures_refined/nightly/2026-02-19-ops-full-dashboard-r1/visual_post_internal_post_ww_domain_fip35_sample000_step00020.pdb`
- prediction_fingerprint: `size=11769;sha256_16=6605f84195db51e8`
- native_pdb: `data/native/ww_domain_fip35.pdb`
- native_fingerprint: `size=2872;sha256_16=edad180e4f36b190`
