# Competitive-Floor Batch Row 10: hist_REQUIRED_MONOMER_010

- target placeholder: `REQUIRED_MONOMER_010`
- expected scope: `monomer`
- metric profile: `TM,GDT_TS,CA_lDDT`
- source row folder: `runs/casp17_win_tier_benchmark_input_scaffold_current/row_010_REQUIRED_MONOMER_010`
- copied row folder: `casp17/competitive_floor_batch_current/priority_010_REQUIRED_MONOMER_010/row_scaffold`
- metadata template: `casp17/competitive_floor_batch_current/priority_010_REQUIRED_MONOMER_010/row_metadata_template.csv`
- single-file fill template: `casp17/competitive_floor_batch_current/priority_010_REQUIRED_MONOMER_010/row_fill_template.csv`
- missing evidence items: `32`
- next action: Replace placeholder target identity and row metadata in runs/casp17_win_tier_benchmark_input_scaffold_current/row_010_REQUIRED_MONOMER_010 with a cleared historical non-current CASP target.
