# Competitive-Floor Batch Row 15: hist_REQUIRED_COMPLEX_005

- target placeholder: `REQUIRED_COMPLEX_005`
- expected scope: `complex`
- metric profile: `TM,interface_F1,DockQ,QSbest,IPS`
- source row folder: `runs/casp17_win_tier_benchmark_input_scaffold_current/row_030_REQUIRED_COMPLEX_005`
- copied row folder: `casp17/competitive_floor_batch_current/priority_015_REQUIRED_COMPLEX_005/row_scaffold`
- metadata template: `casp17/competitive_floor_batch_current/priority_015_REQUIRED_COMPLEX_005/row_metadata_template.csv`
- single-file fill template: `casp17/competitive_floor_batch_current/priority_015_REQUIRED_COMPLEX_005/row_fill_template.csv`
- missing evidence items: `34`
- next action: Replace placeholder target identity and row metadata in runs/casp17_win_tier_benchmark_input_scaffold_current/row_030_REQUIRED_COMPLEX_005 with a cleared historical non-current CASP target.
