# Competitive-Floor Batch Row 14: hist_REQUIRED_COMPLEX_004

- target placeholder: `REQUIRED_COMPLEX_004`
- expected scope: `complex`
- metric profile: `TM,interface_F1,DockQ,QSbest,IPS`
- source row folder: `runs/casp17_win_tier_benchmark_input_scaffold_current/row_029_REQUIRED_COMPLEX_004`
- copied row folder: `casp17/competitive_floor_batch_current/priority_014_REQUIRED_COMPLEX_004/row_scaffold`
- metadata template: `casp17/competitive_floor_batch_current/priority_014_REQUIRED_COMPLEX_004/row_metadata_template.csv`
- single-file fill template: `casp17/competitive_floor_batch_current/priority_014_REQUIRED_COMPLEX_004/row_fill_template.csv`
- missing evidence items: `34`
- next action: Replace placeholder target identity and row metadata in runs/casp17_win_tier_benchmark_input_scaffold_current/row_029_REQUIRED_COMPLEX_004 with a cleared historical non-current CASP target.
