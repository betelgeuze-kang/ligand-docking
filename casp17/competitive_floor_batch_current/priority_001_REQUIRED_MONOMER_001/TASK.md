# Competitive-Floor Batch Row 1: hist_REQUIRED_MONOMER_001

- target placeholder: `REQUIRED_MONOMER_001`
- expected scope: `monomer`
- metric profile: `TM,GDT_TS,CA_lDDT`
- source row folder: `runs/casp17_win_tier_benchmark_input_scaffold_current/row_001_REQUIRED_MONOMER_001`
- copied row folder: `casp17/competitive_floor_batch_current/priority_001_REQUIRED_MONOMER_001/row_scaffold`
- metadata template: `casp17/competitive_floor_batch_current/priority_001_REQUIRED_MONOMER_001/row_metadata_template.csv`
- single-file fill template: `casp17/competitive_floor_batch_current/priority_001_REQUIRED_MONOMER_001/row_fill_template.csv`
- missing evidence items: `32`
- next action: Replace placeholder target identity and row metadata in runs/casp17_win_tier_benchmark_input_scaffold_current/row_001_REQUIRED_MONOMER_001 with a cleared historical non-current CASP target.
