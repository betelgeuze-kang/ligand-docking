# Competitive-Floor Batch Row 5: hist_REQUIRED_MONOMER_005

- target placeholder: `REQUIRED_MONOMER_005`
- expected scope: `monomer`
- metric profile: `TM,GDT_TS,CA_lDDT`
- source row folder: `runs/casp17_win_tier_benchmark_input_scaffold_current/row_005_REQUIRED_MONOMER_005`
- copied row folder: `casp17/competitive_floor_batch_current/priority_005_REQUIRED_MONOMER_005/row_scaffold`
- metadata template: `casp17/competitive_floor_batch_current/priority_005_REQUIRED_MONOMER_005/row_metadata_template.csv`
- single-file fill template: `casp17/competitive_floor_batch_current/priority_005_REQUIRED_MONOMER_005/row_fill_template.csv`
- missing evidence items: `32`
- next action: Replace placeholder target identity and row metadata in runs/casp17_win_tier_benchmark_input_scaffold_current/row_005_REQUIRED_MONOMER_005 with a cleared historical non-current CASP target.
