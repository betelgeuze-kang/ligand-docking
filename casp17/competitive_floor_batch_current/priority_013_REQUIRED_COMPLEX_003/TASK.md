# Competitive-Floor Batch Row 13: hist_REQUIRED_COMPLEX_003

- target placeholder: `REQUIRED_COMPLEX_003`
- expected scope: `complex`
- metric profile: `TM,interface_F1,DockQ,QSbest,IPS`
- source row folder: `runs/casp17_win_tier_benchmark_input_scaffold_current/row_028_REQUIRED_COMPLEX_003`
- copied row folder: `casp17/competitive_floor_batch_current/priority_013_REQUIRED_COMPLEX_003/row_scaffold`
- metadata template: `casp17/competitive_floor_batch_current/priority_013_REQUIRED_COMPLEX_003/row_metadata_template.csv`
- single-file fill template: `casp17/competitive_floor_batch_current/priority_013_REQUIRED_COMPLEX_003/row_fill_template.csv`
- missing evidence items: `34`
- next action: Replace placeholder target identity and row metadata in runs/casp17_win_tier_benchmark_input_scaffold_current/row_028_REQUIRED_COMPLEX_003 with a cleared historical non-current CASP target.
