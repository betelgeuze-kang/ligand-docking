# Competitive-Floor Batch Row 6: hist_REQUIRED_MONOMER_006

- target placeholder: `REQUIRED_MONOMER_006`
- expected scope: `monomer`
- metric profile: `TM,GDT_TS,CA_lDDT`
- source row folder: `runs/casp17_win_tier_benchmark_input_scaffold_current/row_006_REQUIRED_MONOMER_006`
- copied row folder: `casp17/competitive_floor_batch_current/priority_006_REQUIRED_MONOMER_006/row_scaffold`
- metadata template: `casp17/competitive_floor_batch_current/priority_006_REQUIRED_MONOMER_006/row_metadata_template.csv`
- single-file fill template: `casp17/competitive_floor_batch_current/priority_006_REQUIRED_MONOMER_006/row_fill_template.csv`
- missing evidence items: `32`
- next action: Replace placeholder target identity and row metadata in runs/casp17_win_tier_benchmark_input_scaffold_current/row_006_REQUIRED_MONOMER_006 with a cleared historical non-current CASP target.
