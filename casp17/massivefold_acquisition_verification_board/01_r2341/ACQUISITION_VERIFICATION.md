# R2341 MassiveFold Acquisition Verification

- model_set_id: `R2341`
- tarball_url: `ftp://files.plbs.fr:21211/CASP17-CAPRI/R2341_all_cifs_MassiveFold.tar.gz`
- download_path: `casp17/massivefold_external_pool_intake/r2341/downloads/R2341_all_cifs_MassiveFold.tar.gz`
- sha256_path: `casp17/massivefold_external_pool_intake/r2341/hashes/R2341_all_cifs_MassiveFold.tar.gz.sha256`
- listing_path: `casp17/massivefold_external_pool_intake/r2341/extracted_models/tarball_listing.txt`
...
```bash
mkdir -p casp17/massivefold_external_pool_intake/r2341/downloads casp17/massivefold_external_pool_intake/r2341/hashes casp17/massivefold_external_pool_intake/r2341/extracted_models
curl --fail --location --continue-at - --output casp17/massivefold_external_pool_intake/r2341/downloads/R2341_all_cifs_MassiveFold.tar.gz 'ftp://files.plbs.fr:21211/CASP17-CAPRI/R2341_all_cifs_MassiveFold.tar.gz'
