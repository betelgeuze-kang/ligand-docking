# HIST_PROTEIN_A_BDOMAIN ablation_not_ready Repair

- action: `first_slot_repair_051`
...
- evidence pointer: `casp17/historical_seed_ablation_candidate_manifests/06_hist_protein_a_bdomain_ablation_candidates.csv`
