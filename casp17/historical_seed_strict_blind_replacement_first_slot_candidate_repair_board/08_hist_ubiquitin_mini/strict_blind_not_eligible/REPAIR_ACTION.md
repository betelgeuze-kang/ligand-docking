# HIST_UBIQUITIN_MINI strict_blind_not_eligible Repair

- action: `first_slot_repair_087`
- status: `blocked_waiting_on_primary_repairs`
- repair class: `eligibility`
- candidate: `HIST_UBIQUITIN_MINI` `hist_seed_ubiquitin_mini`
- field/dropzone field: `target_identity_non_current_historical` `target_identity_non_current_historical`
- evidence pointer: `casp17/historical_seed_strict_blind_replacement_first_slot_local_candidate_board/08_hist_ubiquitin_mini`
