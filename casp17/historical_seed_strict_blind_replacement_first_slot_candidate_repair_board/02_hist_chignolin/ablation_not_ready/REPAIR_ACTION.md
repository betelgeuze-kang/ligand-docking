# HIST_CHIGNOLIN ablation_not_ready Repair

- action: `first_slot_repair_047`
...
- evidence pointer: `casp17/historical_seed_ablation_candidate_manifests/02_hist_chignolin_ablation_candidates.csv`
