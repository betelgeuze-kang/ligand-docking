# HIST_CRAMBIN ablation_not_ready Repair

- action: `first_slot_repair_048`
...
- evidence pointer: `casp17/historical_seed_ablation_candidate_manifests/03_hist_crambin_ablation_candidates.csv`
