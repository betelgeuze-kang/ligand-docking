# HIST_TRP_CAGE strict_blind_not_eligible Repair

- action: `first_slot_repair_086`
...
- evidence pointer: `casp17/historical_seed_strict_blind_replacement_first_slot_local_candidate_board/07_hist_trp_cage`
