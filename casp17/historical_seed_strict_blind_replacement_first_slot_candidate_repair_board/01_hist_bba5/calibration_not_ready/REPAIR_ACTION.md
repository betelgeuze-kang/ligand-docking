# HIST_BBA5 calibration_not_ready Repair

- action: `first_slot_repair_063`
...
- evidence pointer: `casp17/historical_seed_calibration_candidate_ledgers/01_hist_bba5_calibration_candidates.csv`
