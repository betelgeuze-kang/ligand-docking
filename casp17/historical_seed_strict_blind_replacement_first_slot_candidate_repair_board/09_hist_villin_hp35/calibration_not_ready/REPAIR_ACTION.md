# HIST_VILLIN_HP35 calibration_not_ready Repair

- action: `first_slot_repair_071`
...
- evidence pointer: `casp17/historical_seed_calibration_candidate_ledgers/09_hist_villin_hp35_calibration_candidates.csv`
