# HIST_FSD_1 calibration_not_ready Repair

- action: `first_slot_repair_066`
...
- evidence pointer: `casp17/historical_seed_calibration_candidate_ledgers/04_hist_fsd_1_calibration_candidates.csv`
