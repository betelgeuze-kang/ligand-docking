# HIST_FSD_1 strict_blind_not_eligible Repair

- action: `first_slot_repair_083`
- status: `blocked_waiting_on_primary_repairs`
- repair class: `eligibility`
- candidate: `HIST_FSD_1` `hist_seed_fsd_1`
- field/dropzone field: `target_identity_non_current_historical` `target_identity_non_current_historical`
- evidence pointer: `casp17/historical_seed_strict_blind_replacement_first_slot_local_candidate_board/04_hist_fsd_1`
