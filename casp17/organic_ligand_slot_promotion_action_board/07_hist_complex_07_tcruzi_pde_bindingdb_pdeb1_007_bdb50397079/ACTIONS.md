# organic_ligand_slot_candidate_007 Promotion Actions
...
| `affinity_numeric_label` | `open_affinity_source_required` | `Kendall_tau_affinity` | `find or attach numeric affinity evidence before affinity ranking is included` |
