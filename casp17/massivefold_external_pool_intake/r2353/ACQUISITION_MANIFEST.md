# R2353 MassiveFold External Pool

- pool_id: `massivefold_external_pool_014`
...
```bash
mkdir -p casp17/massivefold_external_pool_intake/r2353/downloads casp17/massivefold_external_pool_intake/r2353/extracted_models casp17/massivefold_external_pool_intake/r2353/hashes
curl -L -o casp17/massivefold_external_pool_intake/r2353/downloads/R2353_all_cifs_MassiveFold.tar.gz 'ftp://files.plbs.fr:21211/CASP17-CAPRI/R2353_all_cifs_MassiveFold.tar.gz'
