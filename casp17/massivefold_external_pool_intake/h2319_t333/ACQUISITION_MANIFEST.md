# H2319_T333 MassiveFold External Pool

- pool_id: `massivefold_external_pool_008`
- primary_target_id: `H2319`
...
```bash
mkdir -p casp17/massivefold_external_pool_intake/h2319_t333/downloads casp17/massivefold_external_pool_intake/h2319_t333/extracted_models casp17/massivefold_external_pool_intake/h2319_t333/hashes
curl -L -o casp17/massivefold_external_pool_intake/h2319_t333/downloads/H2319_T333_all_pdbs_MassiveFold.tar.gz 'ftp://files.plbs.fr:21211/CASP17-CAPRI/H2319_T333_all_pdbs_MassiveFold.tar.gz'
