# H2339_T332 MassiveFold External Pool

- pool_id: `massivefold_external_pool_006`
- primary_target_id: `H2339`
...
```bash
mkdir -p casp17/massivefold_external_pool_intake/h2339_t332/downloads casp17/massivefold_external_pool_intake/h2339_t332/extracted_models casp17/massivefold_external_pool_intake/h2339_t332/hashes
curl -L -o casp17/massivefold_external_pool_intake/h2339_t332/downloads/H2339_T332_all_pdbs_MassiveFold.tar.gz 'ftp://files.plbs.fr:21211/CASP17-CAPRI/H2339_T332_all_pdbs_MassiveFold.tar.gz'
