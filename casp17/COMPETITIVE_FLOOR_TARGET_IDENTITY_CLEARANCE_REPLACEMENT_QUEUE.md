...
- ready/missing-prediction/current-collision/source-repair/no-candidate: `0/2/4/2/0`
- first open: `H1319` -> `H1311` `operator_source_repair_required`
- first next action: repair missing local evidence before moving this candidate into clearance workorders

## Replacement Candidates

| replace | rank | candidate | status | prediction | validation | scorecard | blockers | next action |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- |
| `H1319` | 1 | `H1311` NRAS17.3.2_Q61K_HLAA1 | `operator_source_repair_required` | `runs/casp17_prediction_jobs_current/H1311/H1311_model_1.pdb` | `runs/casp17_internal_physics_raw_validations_current/H1311_raw_confidence_calibration.json` | `-` | `scorecard_missing` | repair missing local evidence before moving this candidate into clearance workorders |
