...
| --- | --- | --- | --- | --- | --- |
| `blocked_current_target_collision` | `relaxed` `Human astrovirus VA1 capsid spike` | `8UFN` | `2024-02-14` | `H2321` | `current_target_name_collision,relaxed_query_match_requires_operator_review,candidate_public_before_target_entry` |
| `blocked_current_target_collision` | `relaxed` `Human astrovirus VA1 capsid spike` | `8UFO` | `2024-02-14` | `H2321` | `current_target_name_collision,relaxed_query_match_requires_operator_review,candidate_public_before_target_entry` |
