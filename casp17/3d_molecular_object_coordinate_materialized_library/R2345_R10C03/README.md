# R2345_R10C03 Materialized Coordinates
...
| --- | --- | --- |
| `massivefold_model1_candidate` | `casp17/3d_molecular_object_coordinate_materialized_library/R2345_R10C03/massivefold_model1_candidate/coordinates/model.cif` | `true` |
