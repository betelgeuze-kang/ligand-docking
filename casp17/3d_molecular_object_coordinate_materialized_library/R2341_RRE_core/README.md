# R2341_RRE_core Materialized Coordinates
...
| --- | --- | --- |
| `massivefold_model1_candidate` | `casp17/3d_molecular_object_coordinate_materialized_library/R2341_RRE_core/massivefold_model1_candidate/coordinates/model.cif` | `true` |
