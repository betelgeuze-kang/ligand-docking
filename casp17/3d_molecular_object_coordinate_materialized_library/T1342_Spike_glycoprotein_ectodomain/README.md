# T1342_Spike_glycoprotein_ectodomain Materialized Coordinates
...
| --- | --- | --- |
| `current_chain_A` | `casp17/3d_molecular_object_coordinate_materialized_library/T1342_Spike_glycoprotein_ectodomain/current_chain_A/coordinates/T1342_chain_A.pdb` | `true` |
