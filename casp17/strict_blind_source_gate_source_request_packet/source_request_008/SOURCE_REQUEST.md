...
- request: `source_request_008` `awaiting_pre_native_source_or_replacement` `pre_native_prediction_source_required`
- candidate: `HIST_UBIQUITIN_MINI` `monomer` rank `8`
- route: `first_slot_source_route_008` `in_scope_current_candidate_disqualified_post_native` blocker `prediction_not_before_native`
- prediction/native dates: `2026-02-19` / `1987-01-02`
- current prediction: `data/internal_structures_refined/nightly/2026-02-19-ops-full-dashboard-r1/visual_post_internal_post_ubiquitin_mini_sample000_step00020.pdb`
- current native: `casp17/historical_seed_native_replacement_candidates/08_hist_ubiquitin_mini/native_candidate_1UBQ.pdb`
- native authority: `rcsb:1UBQ;doi:10.2210/pdb1ubq/pdb`
