...
- request: `source_request_005` `awaiting_pre_native_source_or_replacement` `pre_native_prediction_source_required`
- candidate: `HIST_GB1_MINI` `monomer` rank `5`
- route: `first_slot_source_route_005` `in_scope_current_candidate_disqualified_post_native` blocker `prediction_not_before_native`
- prediction/native dates: `2026-02-19` / `1991-05-15`
- current prediction: `data/internal_structures_refined/nightly/2026-02-19-ops-full-dashboard-r1/visual_post_internal_post_gb1_mini_sample000_step00020.pdb`
- current native: `casp17/historical_seed_native_replacement_candidates/05_hist_gb1_mini/native_candidate_2GB1.pdb`
- native authority: `rcsb:2GB1;doi:10.2210/pdb2gb1/pdb`
