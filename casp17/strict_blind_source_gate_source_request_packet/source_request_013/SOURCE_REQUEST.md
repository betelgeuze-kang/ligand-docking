...
- request: `source_request_013` `out_of_scope_replace_candidate` `candidate_replacement_required`
- candidate: `HIST_COMPLEX_03_TCRUZI_PDE_EXTERNAL_PDEB1_025_CHEMBL4441871` `complex` rank `13`
- route: `first_slot_source_route_013` `out_of_scope_context_only_for_first_slot` blocker `native_authority_missing`
- prediction/native dates: `2026-05-17` / `-`
- current prediction: `runs/wetlab_tcruzi_pde_atomized_parameterization_minimization_current/03_tcruzi_pde_external_pdeb1_025_chembl4441871/protein_ligand_complex_minimized.pdb`
- current native: `runs/wetlab_tcruzi_pde_atomized_parameterization_minimization_current/03_tcruzi_pde_external_pdeb1_025_chembl4441871/protein_ligand_complex.pdb`
- native authority: `-`
