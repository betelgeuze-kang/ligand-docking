...
- request: `source_request_012` `out_of_scope_replace_candidate` `candidate_replacement_required`
- candidate: `HIST_COMPLEX_02_TCRUZI_PDE_EXTERNAL_PDEB1_043_CHEMBL2171451` `complex` rank `12`
- route: `first_slot_source_route_012` `out_of_scope_context_only_for_first_slot` blocker `native_authority_missing`
- prediction/native dates: `2026-05-17` / `-`
- current prediction: `runs/wetlab_tcruzi_pde_atomized_parameterization_minimization_current/02_tcruzi_pde_external_pdeb1_043_chembl2171451/protein_ligand_complex_minimized.pdb`
- current native: `runs/wetlab_tcruzi_pde_atomized_parameterization_minimization_current/02_tcruzi_pde_external_pdeb1_043_chembl2171451/protein_ligand_complex.pdb`
- native authority: `-`
