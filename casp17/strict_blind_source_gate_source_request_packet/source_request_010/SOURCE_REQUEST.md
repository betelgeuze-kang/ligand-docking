...
- request: `source_request_010` `awaiting_pre_native_source_or_replacement` `pre_native_prediction_source_required`
- candidate: `HIST_WW_DOMAIN_FIP35` `monomer` rank `10`
- route: `first_slot_source_route_010` `in_scope_current_candidate_disqualified_post_native` blocker `prediction_not_before_native`
- prediction/native dates: `2026-02-19` / `2005-11-15`
- current prediction: `data/internal_structures_refined/nightly/2026-02-19-ops-full-dashboard-r1/visual_post_internal_post_ww_domain_fip35_sample000_step00020.pdb`
- current native: `casp17/historical_seed_native_replacement_candidates/10_hist_ww_domain_fip35/native_candidate_2F21.pdb`
- native authority: `rcsb:2F21;doi:10.2210/pdb2f21/pdb`
