# HIST_WW_DOMAIN_FIP35 Authoritative Chronology Audit

- status: `post_native_prediction_chronology_blocked`
- benchmark: `hist_seed_ww_domain_fip35`
- scope: `monomer`
- prediction candidate: `2026-02-19` `chronology_board_prediction_path_date`
- native authority date: `2005-11-15` `pdb_header_date:rcsb:2F21;doi:10.2210/pdb2f21/pdb`
- native authority: `authority_pass` `rcsb:2F21;doi:10.2210/pdb2f21/pdb`
