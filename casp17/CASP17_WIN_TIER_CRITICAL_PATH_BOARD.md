...
- stages ready/blocked/total: `3/5/8`
...
- first blocked stage: `win_tier_metric_surface` blocker `hist_REQUIRED_MONOMER_001`
- first next action: fill strict-blind prediction/native/no-leak evidence for 40 historical slots and add organic ligand-protein historical slots before claiming full CASP17 win-tier metric surface
- first artifact: `casp17/casp17_win_tier_metric_surface_contract_current.json`
