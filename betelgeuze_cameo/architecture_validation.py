...
def _row(
    *,
    ...
    return {
        "lane_id": lane_id,
        "status": status,
        "live_external_validation_channel": True,
        "product_release_blocker": False,
        "observed": observed,
        "required": required,
...
def build_cameo_architecture_validation_contract(
    *,
    ...
    summary = {
        ...
        "cameo_live_validation_evidence_ready": cameo_architecture_validation_ready,
        "official_results_live_evidence_ready": official_results_ready,
        "official_results_required_for_product_release": False,
        "official_results_intake_artifact": official_results_path,
        "registration_required_for_product_release": False,
        "registration_evidence_artifact": public_registration_path,
        "receiver_api_readiness_ready": service_boundary_ready and api_contract_ready,
        "development_blocked_by_cameo_registration": False,
        "server_registration_mutated": False,
        "prediction_generation_enabled": False,
        "outbound_email_enabled": False,
        "native_local_accuracy_used": False,
