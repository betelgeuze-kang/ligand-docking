...
from tools import build_wetlab_cathepsin_k_exploratory_retry_lane as mod


def test_build_wetlab_cathepsin_k_exploratory_retry_lane_prefers_gate45() -> None:
    ...
    assert summary["status"] == "wetlab_cathepsin_k_exploratory_retry_lane_ready"
...
def test_build_wetlab_cathepsin_k_exploratory_retry_lane_marks_followup_phase() -> None:
    payload = mod.build_payload(
        hold_guard_payload={
            "summary": {"guard_limit": 3},
            "rows": [
        ...
        execution_queue_payload={
            "rows": [
                {"target_id": "Cathepsin K", "shard_id": "05_of_20", "queue_status": "result_ready"},
                {"target_id": "Cathepsin K", "shard_id": "06_of_20", "queue_status": "explicit_hold"},
                {"target_id": "Cathepsin K", "shard_id": "07_of_20", "queue_status": "explicit_hold"},
                {"target_id": "Cathepsin K", "shard_id": "09_of_20", "queue_status": "ready_after_previous_shard"},
            ]
        },
