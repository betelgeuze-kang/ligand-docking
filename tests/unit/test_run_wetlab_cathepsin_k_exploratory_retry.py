...
from tools import run_wetlab_cathepsin_k_exploratory_retry as mod


def test_run_wetlab_cathepsin_k_exploratory_retry_refreshes_lane_before_launch(monkeypatch, tmp_path) -> None:
    ...
    assert captured["target_id"] == "Cathepsin K"
