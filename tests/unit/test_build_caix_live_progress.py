...
from tools import build_caix_live_progress as mod
from tools.wetlab_target_render_utils import load_json


def test_build_caix_live_progress_defaults_to_not_started() -> None:
