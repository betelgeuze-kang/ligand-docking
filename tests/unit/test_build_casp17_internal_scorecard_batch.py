...
def _framework_artifacts(root: Path, *, accuracy_status: str = "green") -> None:
    ...
    _write_json(root / "runs/accuracy_parity_scorecard_current.json", {"summary": {"status": accuracy_status}})
