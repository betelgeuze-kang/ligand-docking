...
from tests.support.artifact_io import artifact_summary as _artifact_summary
from tests.support.product_route_contracts import assert_product_routes_registered
...
def test_api_product_router_is_registered_when_fastapi_is_available() -> None:
    ...
    product = assert_product_routes_registered()
