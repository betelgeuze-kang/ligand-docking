...
def _write_goal_api_surface(root: Path, *, include_router: bool = True, include_status_key: bool = True) -> None:
    ...
    (root / "api" / "goal.py").write_text(
        ...
        '"operator_action_board_full_commercial_release_blocker_ids": ["R8_full_scope_claim_closure", "R9_engine_refinement_claim_promotion", "MASTER:SCI-CLAIM", "ACCURACY:ligand_ranking"],'
        '"operator_action_board_full_commercial_release_blocker_count": 4,'
        '"operator_intake_kit_full_commercial_release_blocker_ids": ["R8_full_scope_claim_closure", "R9_engine_refinement_claim_promotion", "MASTER:SCI-CLAIM", "ACCURACY:ligand_ranking"],'
        '"operator_intake_kit_full_commercial_release_blocker_count": 4,'
        '"bottleneck_briefing_full_commercial_release_blocker_ids": ["R8_full_scope_claim_closure", "R9_engine_refinement_claim_promotion", "MASTER:SCI-CLAIM", "ACCURACY:ligand_ranking"],'
        '"bottleneck_briefing_full_commercial_release_blocker_count": 4,'
        ...
        '"master_gap_closure_rollup_open_gap_ids": ["SCI-CLAIM"],'
        '"master_gap_closure_rollup_closed_gap_count": 8,'
        '"master_gap_closure_rollup_closed_gap_ids": ["COMMERCIAL"],'
        '"master_gap_closure_rollup_release_blocker_row_count": 1,'
        '"master_gap_closure_rollup_current_primary_open_gap_id": "SCI-CLAIM",'
        '"master_gap_closure_rollup_science_claim_rollup_status": "blocked_science_claim_promotion_gap_closure",'
        ...
        '"science_claim_promotion_gap_closure_closed_gap_ids": ["SCI-TRANS"],'
        ...
        '"science_claim_promotion_gap_closure_gpcr_claim_promotion_status": "blocked_ci_low_oprm1",'
        ...
        '"product_accuracy_parity_ligand_ranking_action_id": "product_accuracy_parity:repair_ligand_ranking_parity",'
        ...
        '"product_accuracy_parity_ligand_ranking_action_status": "blocked",'
        '"product_accuracy_parity_ligand_ranking_blocker_count": 4,'
        '"product_accuracy_parity_ligand_ranking_blockers": ["claim_promotion_not_allowed"],'
        '"product_accuracy_parity_ligand_ranking_pr_auc": 0.15749,'
        '"product_accuracy_parity_ligand_ranking_pr_auc_ci_low": 0.001347,'
        '"product_accuracy_parity_ligand_ranking_topk_hit_rate": 0.1,'
        '"product_accuracy_parity_ligand_ranking_next_required_step": "Repair GPCR ligand-ranking parity",'
        '"product_accuracy_parity_scorecard_json": "runs/accuracy_parity_scorecard_current.json",'
        '"repair_ligand_ranking_parity": True,'
