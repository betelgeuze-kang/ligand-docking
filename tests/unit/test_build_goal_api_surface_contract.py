...
def _write_goal_api_surface(root: Path, *, include_router: bool = True, include_status_key: bool = True) -> None:
    ...
    (root / "api" / "goal.py").write_text(
        ...
        "API_CUSTOMER_FLOW_RELEASE_EVIDENCE_ARTIFACT = 'runs/api_customer_flow_release_evidence_current.json'\n"
        ...
        "COMPETITION_BENCHMARK_ROLLUP_ARTIFACT = 'runs/competition_benchmark_rollup_current.json'\n"
        ...
        '"competition_benchmark_rollup_artifact_path": COMPETITION_BENCHMARK_ROLLUP_ARTIFACT,'
        '"competition_benchmark_cameo_api_dependency_ready": True,'
        '"competition_benchmark_cameo_receiver_smoke_ready": True,'
        '"competition_benchmark_cameo_format_validation_ready": True,'
        '"competition_benchmark_cameo_model1_selection_ready": True,'
        '"competition_benchmark_cameo_dry_run_handoff_ready": True,'
        '"competition_benchmark_cameo_validation_status": "cameo_validation_pending_official_results",'
        '"competition_benchmark_cameo_validation_next_action": "Fill official rows.",'
        '"competition_benchmark_cameo_official_results_used": False,'
        '"competition_benchmark_cameo_official_intake_row_count": 0,'
        '"competition_benchmark_cameo_official_intake_gate_status": "blocked_cameo_official_results_intake",'
        '"competition_benchmark_cameo_official_intake_gate_ready": False,'
        '"competition_benchmark_cameo_official_intake_gate_artifact_path": "runs/cameo_official_results_intake_gate_current.json",'
        '"competition_benchmark_cameo_official_operator_intake_csv": "runs/cameo_official_results_operator_intake.csv",'
        '"competition_benchmark_cameo_official_operator_template_csv": "runs/cameo_official_results_operator_template_current.csv",'
        ...
        '"competition_benchmark_cameo_official_blocker_codes": ["official_result_rows_missing"],'
        '"competition_benchmark_cameo_official_required_column_count": 8,'
        '"competition_benchmark_cameo_official_missing_required_column_count": 8,'
        '"competition_benchmark_cameo_official_missing_required_columns": ["target_id"],'
        ...
        '"competition_benchmark_cameo_official_next_action": "Fill official CAMEO assessment rows.",'
        '"competition_benchmark_casp_strict_blind_first_slot_ready": False,'
        '"competition_benchmark_casp_strict_blind_blocked_check_count": 1,'
        '"competition_benchmark_casp_strict_blind_next_action": "Provide strict-blind source.",'
        '"competition_benchmark_casp_winner_band_unblocked_count": 0,'
        '"competition_benchmark_casp_winner_band_total_count": 3,'
        '"competition_benchmark_casp16_ligand_source_manifest_status": "blocked_casp16_ligand_competition_credibility",'
        '"competition_benchmark_casp16_ligand_source_manifest_ready": True,'
        ...
        '"competition_benchmark_casp16_ligand_pose_target_count": 233,'
        '"competition_benchmark_casp16_ligand_affinity_target_count": 140,'
        '"competition_benchmark_casp16_ligand_next_action": "Attach local CASP16 ligand receipts.",'
        '"competition_benchmark_bm5_capri_complex_source_manifest_status": "blocked_bm5_capri_complex_competition_credibility",'
        '"competition_benchmark_bm5_complex_benchmark_ready": True,'
        ...
        '"competition_benchmark_bm5_capri_complex_raw_data_committed": True,'
        '"competition_benchmark_bm5_capri_complex_raw_data_git_tracked_file_count": 2802,'
        '"competition_benchmark_bm5_capri_complex_primary_metric": "CAPRI quality category",'
        '"competition_benchmark_bm5_capri_complex_next_action": "Attach CAPRI score_set receipts.",'
        ...
        '"competition_benchmark_competition_credibility_extension_blockers": ["casp16_ligand_materialization_not_ready", "casp16_ligand_scorecard_not_ready", "capri_score_set_not_ready"],'
        '"competition_benchmark_competition_credibility_extension_primary_blocker": "casp16_ligand_materialization_not_ready",'
        '"competition_benchmark_competition_credibility_extension_next_actions": ["Attach local CASP16 ligand receipts.", "Attach CAPRI score_set receipts."],'
        '"competition_benchmark_competition_credibility_extension_primary_next_action": "Attach local CASP16 ligand receipts.",'
        '"competition_benchmark_custody_work_order_status": "blocked_competition_benchmark_custody_work_order",'
        ...
        '"competition_benchmark_custody_work_order_primary_work_order_id": "casp16_ligand_operator_receipts_missing",'
        '"competition_benchmark_custody_work_order_primary_required_action": "Place reviewed CASP16 ligand source/checksum/materialization/scorecard receipts.",'
        '"competition_benchmark_custody_work_order_primary_verification_command": "python3 tools/build_casp16_ligand_materialization_manifest.py --source-manifest-csv OPERATOR_LOCAL_SOURCE_MANIFEST --checksum-manifest OPERATOR_LOCAL_CHECKSUMS --out-json runs/casp16_ligand_materialization_manifest_current.json --out-csv runs/casp16_ligand_materialization_manifest_current.csv --out-md runs/casp16_ligand_materialization_manifest_current.md && python3 tools/build_casp16_ligand_scorecard.py --materialization-json runs/casp16_ligand_materialization_manifest_current.json --scorecard-rows-csv OPERATOR_REVIEWED_SCORECARD_ROWS_CSV --out-json runs/casp16_ligand_scorecard_current.json && python3 tools/build_casp16_ligand_source_manifest.py && python3 tools/build_competition_benchmark_custody_work_order.py",'
        '"competition_benchmark_package_b_required_for_ligand_commercial_claims": True,'
        '"competition_benchmark_package_b_public_benchmark_contract_status": "product_public_benchmark_contract_ready",'
        '"competition_benchmark_package_b_public_benchmark_validation_ready": True,'
        '"competition_benchmark_package_b_ligand_public_benchmark_foundation_ready": True,'
        '"competition_benchmark_package_b_ligand_suite_ids": ["pdbbind_casf_pose_affinity", "lit_pcba_virtual_screening", "dude_z_decoy_smoke"],'
        '"competition_benchmark_package_b_refine_tier_public_benchmark_status": "blocked_refine_tier_public_benchmark_readiness",'
        '"competition_benchmark_package_b_claim_grade_public_benchmark_ready": False,'
        '"competition_benchmark_package_b_claim_grade_blocker_count": 6,'
        '"competition_benchmark_package_b_claim_grade_blockers": ["insufficient_total_rows"],'
        '"competition_benchmark_package_b_refine_tier_work_order_apply_status": "blocked_refine_tier_public_benchmark_work_order_apply",'
        '"competition_benchmark_package_b_refine_tier_work_order_apply_ready": False,'
        '"competition_benchmark_competition_evidence_role": "competition_credibility_evidence_only",'
        ...
        '"competition_benchmark_competition_ligand_claim_blockers": ["package_b_claim_grade_public_benchmark_not_ready"],'
        '"competition_benchmark_package_b_bridge_next_action": "Fill Package B refine-tier evidence.",'
        ...
        "async def get_goal_api_customer_flow(): pass\n"
        '@router.get("/actions")\n'
...
def test_goal_api_surface_contract_reports_ready_for_current_source() -> None:
    ...
    assert summary["expected_endpoint_count"] == 13
