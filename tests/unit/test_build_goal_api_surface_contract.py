...
def _write_goal_api_surface(root: Path, *, include_router: bool = True, include_status_key: bool = True) -> None:
    ...
    (root / "api" / "goal.py").write_text(
        ...
        '"engine_refinement_claim_evidence_priority_top_required_input": "runs/refine_tier_public_benchmark_work_order_current.csv",'
        ...
        '"engine_refinement_claim_evidence_priority_top_verification_command": "python3 tools/product/apply_refine_tier_public_benchmark_work_order.py",'
