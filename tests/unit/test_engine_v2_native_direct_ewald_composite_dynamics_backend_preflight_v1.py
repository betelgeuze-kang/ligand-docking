...
pytestmark = pytest.mark.skipif(
    PARTICLE_MESH_EWALD_COMPOSITE_DYNAMICS_EVIDENCE_PRESENT,
    reason=(
        "legacy direct Ewald composite dynamics backend preflight evidence is verified "
        "from its exact frozen object after particle-mesh Ewald composite dynamics "
        "evidence is present"
    ),
)
