...
| --- | --- | --- | ---: | --- | --- | --- |
| `lit_pcba_virtual_screening` | `materialization_required` | `EF1` | `1.2` | `local public benchmark dataset/result artifacts for https://zenodo.org/records/4588239; materialization_manifest=/home/betelgeuze/분자동역학/runs/lit_pcba_materialization_manifest_current.json; blockers=extracted_dir_missing;source_label_csv_missing;source_score_csv_missing;standardized_labels_csv_missing;standardized_scores_csv_missing;zenodo_archive_missing` | `materialization_manifest=/home/betelgeuze/분자동역학/runs/lit_pcba_materialization_manifest_current.json;scorecard_json=/home/betelgeuze/분자동역학/runs/lit_pcba_scorecard_current.json;refresh=runs/product_public_benchmark_contract_current.json` | `materialization_manifest_not_ready,scorecard_json_status_not_pass,scorecard_status_not_pass,primary_metric_below_threshold` |
| `dude_z_decoy_smoke` | `materialization_required` | `ROC_AUC` | `0.6` | `local public benchmark dataset/result artifacts for https://dude.docking.org/; materialization_manifest=/home/betelgeuze/분자동역학/runs/dude_z_decoy_smoke_materialization_manifest_current.json; blockers=dataset_artifact_missing;result_artifact_missing;result_rows_below_minimum` | `materialization_manifest=/home/betelgeuze/분자동역학/runs/dude_z_decoy_smoke_materialization_manifest_current.json;scorecard_json=/home/betelgeuze/분자동역학/runs/dude_z_decoy_smoke_scorecard_current.json;refresh=runs/product_public_benchmark_contract_current.json` | `materialization_manifest_not_ready,scorecard_json_status_not_pass,scorecard_status_not_pass,primary_metric_below_threshold` |
| `pdbbind_casf_pose_affinity` | `materialization_required` | `pose_success_rate` | `0.35` | `local public benchmark dataset/result artifacts for https://www.pdbbind-plus.org.cn/; materialization_manifest=/home/betelgeuze/분자동역학/runs/pdbbind_casf_pose_affinity_materialization_manifest_current.json; blockers=dataset_artifact_missing;result_artifact_missing;result_rows_below_minimum` | `materialization_manifest=/home/betelgeuze/분자동역학/runs/pdbbind_casf_pose_affinity_materialization_manifest_current.json;scorecard_json=/home/betelgeuze/분자동역학/runs/pdbbind_casf_pose_affinity_scorecard_current.json;refresh=runs/product_public_benchmark_contract_current.json` | `materialization_manifest_not_ready,scorecard_json_status_not_pass,scorecard_status_not_pass,primary_metric_below_threshold` |
| `protein_protein_docking_benchmark_v5` | `materialization_required` | `dockq_acceptable_rate` | `0.2` | `local public benchmark dataset/result artifacts for https://pmc.ncbi.nlm.nih.gov/articles/PMC4677049/; materialization_manifest=/home/betelgeuze/분자동역학/runs/protein_protein_docking_benchmark_v5_materialization_manifest_current.json; blockers=dataset_artifact_missing;result_artifact_missing;result_rows_below_minimum` | `materialization_manifest=/home/betelgeuze/분자동역학/runs/protein_protein_docking_benchmark_v5_materialization_manifest_current.json;scorecard_json=/home/betelgeuze/분자동역학/runs/protein_protein_docking_benchmark_v5_scorecard_current.json;refresh=runs/product_public_benchmark_contract_current.json` | `materialization_manifest_not_ready,scorecard_json_status_not_pass,scorecard_status_not_pass,primary_metric_below_threshold` |
| `casp_archive_structure_regression` | `materialization_required` | `target_pass_rate` | `0.5` | `local public benchmark dataset/result artifacts for https://predictioncenter.org/; materialization_manifest=/home/betelgeuze/분자동역학/runs/casp_archive_structure_regression_materialization_manifest_current.json; blockers=dataset_artifact_missing;result_artifact_missing;result_rows_below_minimum` | `materialization_manifest=/home/betelgeuze/분자동역학/runs/casp_archive_structure_regression_materialization_manifest_current.json;scorecard_json=/home/betelgeuze/분자동역학/runs/casp_archive_structure_regression_scorecard_current.json;refresh=runs/product_public_benchmark_contract_current.json` | `materialization_manifest_not_ready,scorecard_json_status_not_pass,scorecard_status_not_pass,primary_metric_below_threshold` |
