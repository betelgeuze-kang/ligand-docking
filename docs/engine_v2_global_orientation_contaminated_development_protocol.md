...
arm introduced by Draft PR #250.
...
```text
betelgeuze.engine_v2_global_orientation_contaminated_development_protocol/1.0.0
```

Protocol self-hash:

```text
bacbbd7cb6efd1bcaf61e27759474a5ec791e9a487d2f6df7724652fa863ea38
```
...
| Synthetic global-orientation contract | `b86059aca76425aacc7a2cc28bac98e9ce87f026b399c6a839e9560ff7332a44` |
...
declared pocket center and normal, bounded receptor surface points, and the
...
1. PR #245 reaches a reviewed terminal state;
