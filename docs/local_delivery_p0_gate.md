...
- the general GPCR 100k family/commercial claim remains `claim_safe=false/blocked`; `residual-v4 apply` failed the core lane (`PR-AUC=0.3888`, `top20=0.15`), `linear C100` full rerun is reject negative evidence (`PR-AUC=0.2367`, `top20=0.05`), `gpcr_core_decoy_intrusion_v1` shadow-first remains blocked (`PR-AUC=0.3910`, `top20=0.15`), `gpcr_core_linear_rescore_v1` remains comparison-only until shadow/guarded-apply evidence is green, and `gpcr_adrb2_beta_blocker_pharmacophore_v1` is target-specific guarded-apply evidence only (`core 100k PR-AUC=1.0000`, `top20=0.30`; `ChEMBL50 PR-AUC=0.9662`, `top20=1.00`) with claim/router/family promotion blocked
