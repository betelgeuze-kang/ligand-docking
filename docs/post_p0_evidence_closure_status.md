...
- `runs/gpcr_guarded_100k_rank_failure_diagnostics_current.md` is the operator packet for the current rank-quality blocker; it carries positive global/within-target ranks, top decoy intrusions, and `next_action=claim-locked family-balanced scoring candidate implementation` for the scoring-candidate work.
