...
containing the current 164 public C symbols. This final-link boundary prevents
the private Rust provider archive, including both direct-Ewald provider entry
