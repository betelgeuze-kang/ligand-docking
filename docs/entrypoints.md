...
| --- | --- | --- | --- |
| Independent Engine v2 reviewer | `docs/engine_v2_status.md` | `docs/engine_v2_native_fixed64_rust_ownership.md`, `docs/engine_v2_public_api.md`, `config/independent_engine_v2_capabilities.yaml`, `betelgeuze_engine_v2/`, `packaging/engine-v2/pyproject.toml` | Bounded CPU reference contracts, strict ingest, docking/benchmark scaffolds, and clean-wheel isolation only. No calibrated docking, MD, free-energy, GPU, or product claim. |
