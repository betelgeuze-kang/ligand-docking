...
Run focused local checks when useful and allowed by permissions. Do not paste full logs into your final response. Report failing test names and only the shortest useful failure snippet.
